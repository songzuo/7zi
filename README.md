...
[![Version](https://img.shields.io/badge/version-0.1.0-blue.svg)](https://github.com/songzuo/7zi)
...
- ✅ **2026-03-08**: 代码重构完成 (UserSettingsPage 713→160行, Dashboard, AboutContent)
- ✅ **2026-03-08**: 依赖升级完成 (eslint v10, web-vitals v5, @types/node v25)
...
**使用示例:**
```tsx
import { TaskBoard, TaskCard, useTasks } from '@/components';
...
function TasksPage() {
  ...
  return <TaskBoard tasks={tasks} onAssign={handleAssign} />;
}
```
