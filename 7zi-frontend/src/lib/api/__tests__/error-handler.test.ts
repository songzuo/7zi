...
describe('API Error Handler', () => {
  ...
  describe('ApiError', () => {
    it('should create ApiError with correct properties', () => {
      const error = new ApiError(ErrorType.VALIDATION, 'Invalid input', 400, { field: 'email' })
  ...
  describe('createErrorResponse', () => {
    ...
    it('should handle generic errors', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith('API Error', error, { category: 'api' })
    })
  ...
  describe('withErrorHandling', () => {
    ...
    it('should pass through arguments', async () => {
      const handler = withErrorHandling((async (arg1: string, arg2: number) => {
        ...
        arg1: string,
        arg2: number
      ) => Promise<NextResponse<SuccessResponse<{ arg1: string; arg2: number }>>>
