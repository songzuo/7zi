  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">✅ 最佳实践</h1>
        
        {/* 无障碍 */}
        <section className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">♿ 无障碍规范</h2>
          
          <div className="space-y-4">
            <div className="border-l-4 border-blue-500 pl-4">
              <h3 className="font-semibold text-gray-900">语义化 HTML</h3>
              <p className="text-gray-600 text-sm mt-1">
                使用正确的 HTML 标签，如 <code>&lt;button&gt;</code> 而非 <code>&lt;div onClick&gt;</code>
              </p>
            </div>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">图片优化</h3>
              <ul className="list-disc list-inside text-gray-600 text-sm space-y-1">
                <li>使用 <code>OptimizedImage</code> 组件自动 WebP/AVIF 转换</li>
                <li>为关键图片（LCP）设置 <code>priority</code></li>
                <li>使用 <code>loading="lazy"</code> 延迟加载非首屏图片</li>
                <li>配置正确的 <code>sizes</code> 属性优化响应式加载</li>
              </ul>
            </div>

            <div>
              <h3 className="font-semibold text-gray-900 mb-2">代码分割</h3>
              <ul className="list-disc list-inside text-gray-600 text-sm space-y-1">
                <li>使用 <code>dynamic</code> 动态导入大型组件</li>
                <li>路由级别的自动代码分割</li>
                <li>第三方库按需导入</li>
              </ul>
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">渲染优化</h3>
              <ul className="list-disc list-inside text-gray-600 text-sm space-y-1">
                <li>使用 <code>React.memo</code> 避免不必要的重渲染</li>
                <li>使用 <code>useMemo</code> 和 <code>useCallback</code> 缓存计算</li>
                <li>列表渲染使用稳定的 <code>key</code> 属性</li>
                <li>虚拟列表处理大数据集</li>
              </ul>
            </div>
          </div>
        ...
        {/* 代码规范 */}
        <section className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">📝 代码规范</h2>
...
/>`}</pre>
        ...
        <section className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">🛡️ 错误处理</h2>
