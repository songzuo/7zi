...
import {
  ...
  PrefetchLink,
  useSmartPrefetch,
} from '@/components/performance/SmartPrefetch'
...
function CardExample() {
  return (
    <div className="grid gap-6 md:grid-cols-2">
      ...
      {/* 带图片的卡片 */}
      <Card hoverable>
        <CardImage src="/example.jpg" alt="示例图片" height="md" zoomOnHover />
        <CardHeader>
        ...
        <CardBody padding="sm">
          <p className="text-gray-600">带有图片的卡片，图片支持悬停缩放效果。</p>
        </CardBody>
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <LoadingWrapper loading={loading} skeleton={<SkeletonList count={3} />} delay={200}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <TaskStatusToggle currentStatus={status} onStatusChange={setStatus} />
...
function NavigationExample() {
  ...
  return (
    <NavigationWithSkeleton loading={loading} delay={200}>
      <NavigationComponent />
...
function PrefetchHookExample() {
  ...
  return (
    <div className="space-y-4">
      <h3>手动触发预加载</h3>
      <Button onClick={() => prefetchNow('/api/data', 'api')}>预加载数据</Button>
      <Button onClick={() => prefetchNow('/settings', 'page')}>预加载设置页</Button>
    </div>
  )
}
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">展示所有新增和改进的组件</p>
        </div>
