...
export default function MobileOptimizationDemo() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      {/* 懒加载演示 */}
      <section className="container mx-auto px-4 py-8 sm:px-6">
        <h2 className="mb-6 text-xl font-bold text-gray-900 sm:text-2xl md:text-3xl dark:text-white">
          懒加载演示
        </h2>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardBody>
              <div
                ref={swipeRef}
                className="cursor-pointer rounded-lg bg-blue-50 p-8 text-center dark:bg-blue-900/20"
              >
          ...
          <Card>
            ...
            <CardBody>
              <div className="relative h-64 w-full overflow-hidden rounded-lg">
                <div ref={zoomRef} className="flex h-full w-full items-center justify-center">
                  <LazyImage
          ...
          <Card>
            ...
            <CardBody>
              ...
              <div className="mt-4 space-y-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <p>
                  ↔️ 平移: ({gestureState.translateX.toFixed(0)},{' '}
                  {gestureState.translateY.toFixed(0)})
                </p>
                <p className="text-xs opacity-75">提示: 双指捏合缩放，单指拖拽平移</p>
              </div>
            </CardBody>
          </Card>
        </div>
        ...
        <Card className="bg-green-50 dark:bg-green-900/20">
          ...
          <CardBody>
            <ul className="space-y-2 text-sm text-gray-700 sm:text-base dark:text-gray-300">
              <li>
                ✅ <strong>懒加载</strong> - 只加载视口内的图片
              </li>
              <li>
                ✅ <strong>响应式图片</strong> - 根据设备加载合适尺寸
              </li>
              <li>
                ✅ <strong>占位符</strong> - 加载时显示骨架屏或模糊图
              </li>
              <li>
                ✅ <strong>淡入动画</strong> - 图片加载完成平滑过渡
              </li>
              <li>
                ✅ <strong>错误处理</strong> - 加载失败显示友好提示
              </li>
              <li>
                ✅ <strong>触摸优化</strong> - 支持原生手势操作
              </li>
              <li>
                ✅ <strong>性能监控</strong> - 自动收集加载指标
              </li>
            </ul>
          </CardBody>
        </Card>
      ...
      <section className="container mx-auto px-4 py-8 sm:px-6">
        <button
          ...
          className="min-h-[48px] w-full rounded-lg bg-blue-600 px-6 py-3 font-medium text-white transition hover:bg-blue-700"
        >
          加载更多图片
        </button>
      </section>
      ...
      {/* 页脚 */}
      <footer className="container mx-auto px-4 py-8 text-center text-sm text-gray-600 sm:px-6 dark:text-gray-400">
