    ...
    <div className="min-h-screen bg-zinc-100 p-6 dark:bg-zinc-950">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div>
          ...
          <p className="text-zinc-600 dark:text-zinc-400">体验性能监控和告警系统的各种功能</p>
        </div>
        ...
        {/* Example Buttons */}
        <div className="rounded-2xl bg-white p-6 shadow-lg dark:bg-zinc-800 dark:shadow-none">
          <h2 className="mb-4 text-xl font-semibold text-zinc-900 dark:text-zinc-100">示例操作</h2>
        ...
        {/* Operation Log */}
        {logs.length > 0 && (
          <div className="rounded-2xl bg-zinc-800 p-6 text-zinc-100 shadow-lg dark:bg-zinc-900 dark:shadow-none">
            <h2 className="mb-4 text-xl font-semibold text-zinc-100 dark:text-zinc-100">
              操作日志
            </h2>
