...
export class AuditLogger {
  ...
  static async logDataAccess(
    eventType: AuditEventType.DATA_READ | AuditEventType.DATA_CREATED | AuditEventType.DATA_UPDATED | AuditEventType.DATA_DELETED,
    data: {
      userId: string;
      username: string;
      ipAddress: string;
  ...
  static async logSecurityEvent(
    eventType: AuditEventType.SECURITY_VIOLATION | AuditEventType.SECURITY_ALERT | AuditEventType.SUSPICIOUS_ACTIVITY,
    data: {
      userId?: string;
      username?: string;
      ipAddress: string;
  ...
  private static getPasswordResetMessage(
    ...
    const action =
      eventType === AuditEventType.PASSWORD_RESET_REQUEST ? 'Password reset requested' : 'Password reset completed';
