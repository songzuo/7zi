      ...
      <div className="space-y-5">
          ...
          <div className="flex items-center justify-center gap-4 text-sm">
            ...
            {maxUses && (
              <div className="flex items-center gap-1 text-gray-600 dark:text-gray-400">
                <span>👥</span>
                <span>
                  {t('uses', '使用次数')}: {currentUses}/{maxUses}
                </span>
              </div>
            )}
          </div>
        ...
        <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-900/50">
          ...
          <div className="flex items-center gap-2">
            <code
              className={clsx(
                'flex-1 rounded bg-white px-4 py-3 text-center dark:bg-gray-800',
            ...
            <button
              ...
              className={clsx(
                'rounded px-4 py-3 font-medium transition-all',
        ...
        <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-900/50">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              value={inviteUrl}
              className={clsx(
                'flex-1 rounded bg-white px-3 py-2 dark:bg-gray-800',
            ...
            <button
              ...
              className={clsx(
                'rounded px-3 py-2 text-sm font-medium transition-all',
        ...
        {qrCodeUrl && (
          <div className="text-center">
            ...
            <div className="inline-block rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700">
              <img src={qrCodeUrl} alt="QR Code" className="rounded" width={200} height={200} />
            </div>
