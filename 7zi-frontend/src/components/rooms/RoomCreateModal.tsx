    ...
    >
      <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="animate-fadeIn">
            <div className="relative">
              ...
              <button
                ...
                className="absolute top-8 right-3 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
              >
                {showPassword ? '🙈' : '👁️'}
              </button>
            </div>
        ...
        <div className="flex gap-3 border-t border-gray-200 pt-4 dark:border-gray-700">
          <Button variant="ghost" onClick={handleClose} type="button" disabled={isLoading}>
            {t('cancel', '取消')}
          </Button>
          <Button
            type="submit"
