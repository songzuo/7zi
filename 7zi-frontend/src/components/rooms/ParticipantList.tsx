...
export const ParticipantList: React.FC<ParticipantListProps> = ({
  ...
  if (error) {
    return (
      <div className={`p-4 bg-red-50 border border-red-200 rounded-lg dark:bg-red-900/20 dark:border-red-800 ${className}`}>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className={`px-2 py-0.5 text-xs rounded-full ${roleColors[participant.role]}`}>
            ...
            {canModifyRole(currentUserRole, participant.role) && (
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="px-2 py-1 text-xs border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-700 dark:text-white"
                >
