...
export function WorkflowEditor({
  ...
  const handleKeyDown = useCallback(
    ...
    [readOnly, selectedNode, setNodes, setEdges, handleSave, handleRun]
  );
  ...
  return (
    <div className="flex h-screen w-screen flex-col bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* 左侧节点面板 */}
        <NodePalette onNodeDragStart={(event, nodeType) => {
        ...
        {selectedNode && !readOnly && (
          <div className="w-80 border-l border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
            <PropertiesPanel
              ...
              onChange={(data) => {
                setNodes((nds) =>
                  nds.map((n) => (n.id === selectedNode.id ? { ...n, data: { ...n.data, ...data } as WorkflowNodeData } : n))
                );
              }}
            />
          </div>
