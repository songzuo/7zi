 ...
 * Three.js is dynamically imported on user interaction (hover/click) to reduce initial bundle size
 ...
 * Dynamically imports Three.js on user interaction and renders the 3D scene
 */
