...
```tsx
// 格式化函数缓存
const formatNumber = useMemo(() => (num: number, decimals: number = 2) => {
  return num.toFixed(decimals);
}, []);

const formatDuration = useMemo(() => (ms: number) => {
...
*报告生成时间: 2026-03-29 22:47 GMT+2*
*子代理会话: agent:main:subagent:0e6b8921-ec76-4455-94ef-1146c5b76e78*
