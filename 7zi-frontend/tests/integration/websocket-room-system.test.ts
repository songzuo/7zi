...
class MockRoomManager {
  ...
  private getDefaultPermissions(): Map<RoomRole, RoomPermission> {
    return new Map([
      ['owner', {
        canEditRoom: true, canDeleteRoom: true, canInviteMembers: true,
        canRemoveMembers: true, canSendMessage: true, canEditMessage: true,
        canDeleteMessage: true, canPinMessage: true, canManageRoles: true,
        canViewHistory: true, canManagePermissions: true, canChangeVisibility: true,
        canArchiveRoom: true, canManageBots: true, canUseVoice: true, canUseVideo: true,
      }],
      ['admin', {
        canEditRoom: true, canDeleteRoom: false, canInviteMembers: true,
        canRemoveMembers: true, canSendMessage: true, canEditMessage: true,
        canDeleteMessage: true, canPinMessage: true, canManageRoles: true,
        canViewHistory: true, canManagePermissions: false, canChangeVisibility: false,
        canArchiveRoom: true, canManageBots: true, canUseVoice: true, canUseVideo: true,
      }],
      ['moderator', {
        canEditRoom: false, canDeleteRoom: false, canInviteMembers: true,
        canRemoveMembers: false, canSendMessage: true, canEditMessage: false,
        canDeleteMessage: true, canPinMessage: true, canManageRoles: false,
        canViewHistory: true, canManagePermissions: false, canChangeVisibility: false,
        canArchiveRoom: false, canManageBots: false, canUseVoice: true, canUseVideo: true,
      }],
      ['member', {
        canEditRoom: false, canDeleteRoom: false, canInviteMembers: false,
        canRemoveMembers: false, canSendMessage: true, canEditMessage: false,
        canDeleteMessage: false, canPinMessage: false, canManageRoles: false,
        canViewHistory: true, canManagePermissions: false, canChangeVisibility: false,
        canArchiveRoom: false, canManageBots: false, canUseVoice: true, canUseVideo: true,
      }],
      ['guest', {
        ...
        canRemoveMembers: false, canSendMessage: true, canEditMessage: false,
        canDeleteMessage: false, canPinMessage: false, canManageRoles: false,
        canViewHistory: false, canManagePermissions: false, canChangeVisibility: false,
        canArchiveRoom: false, canManageBots: false, canUseVoice: false, canUseVideo: false,
      }],
    ]);
  }
  ...
  deleteMessage(roomId: string, messageId: string, userId: string): boolean {
    ...
    const canModerate = permission?.canDeleteMessage && 
      this.hasHigherRole(roomId, userId, message.userId);
  ...
  updateMemberRole(roomId: string, targetUserId: string, newRole: RoomRole, requesterId: string): boolean {
    const room = this.rooms.get(roomId);
    if (!room) return false;
