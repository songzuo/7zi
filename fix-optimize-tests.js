...
content = content.replace(/it\('should calculate database size correctly', async \(\) => \{[\s\S]*?\}\);/gm,
...
content = content.replace(/it\('should calculate fragmentation percentage', async \(\) => \{[\s\S]*?\}\);/gm,
...
content = content.replace(/it\('should generate recommendations for missing indexes', async \(\) => \{[\s\S]*?\}\);/gm,
...
content = content.replace(/it\('should generate recommendations for slow queries', async \(\) => \{[\s\S]*?\}\);/gm,
...
content = content.replace(/it\('should generate recommendations for large database', async \(\) => \{[\s\S]*?\}\);/gm,
...
content = content.replace(/it\('should generate recommendations for high fragmentation', async \(\) => \{[\s\S]*?\}\);/gm,
...
content = content.replace(/it\('should generate recommendations for low cache hit rate', async \(\) => \{[\s\S]*?\}\);/gm,
...
content = content.replace(/it\('should return cache statistics formatted correctly', async \(\) => \{[\s\S]*?\}\);/gm,
...
content = content.replace(/it\('should limit slow queries returned', async \(\) => \{[\s\S]*?\}\);/gm,
