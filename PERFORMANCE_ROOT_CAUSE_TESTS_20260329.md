...
it('should analyze complete waterfall with multiple resources', () => {
  const resources = [
    createMockResourceTiming({ name: 'index.html', startTime: 0, duration: 200, initiatorType: 'document' }),
    createMockResourceTiming({ name: 'style.css', startTime: 200, duration: 100, initiatorType: 'link' }),
    createMockResourceTiming({ name: 'script.js', startTime: 300, duration: 150, initiatorType: 'script' }),
    createMockResourceTiming({ name: 'image.jpg', startTime: 450, duration: 300, initiatorType: 'img' }),
  ];
