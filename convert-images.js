...
const files = [
  ...
  [path.join(__dirname, 'public/apple-touch-icon.png'), path.join(__dirname, 'public/apple-touch-icon.webp')],
  [path.join(__dirname, 'public/apple-touch-startup-image.png'), path.join(__dirname, 'public/apple-touch-startup-image.webp')],
  [path.join(__dirname, 'public/screenshot-narrow.png'), path.join(__dirname, 'public/screenshot-narrow.webp')],
  [path.join(__dirname, 'public/screenshot-wide.png'), path.join(__dirname, 'public/screenshot-wide.webp')],
];
