...
test.describe('User Flow Integration Tests', () => {
  ...
  test('contact form submission flow', async ({ page }) => {
    ...
    await page.fill('textarea[name="message"], textarea[placeholder*="消息"]', 'This is a test message');
  ...
  test('responsive navigation on mobile', async ({ page }) => {
    ...
    await expect(page.locator('[aria-label*="菜单"], .mobile-menu-button, button:has-text("≡")')).toBeVisible();
