...
test.describe('Task Creation Flow', () => {
  ...
  test('should display task creation interface', async ({ page }) => {
    ...
    const createTaskButton = page.locator('button:has-text("新建任务"), button:has-text("New Task"), button:has-text("Create Task"), button:has-text("+")').first();
  ...
  test('should open task creation modal', async ({ page }) => {
    ...
    const createTaskButton = page.locator('button:has-text("新建任务"), button:has-text("New Task"), button:has-text("Create Task")').first();
  ...
  test('should validate task title field', async ({ page }) => {
    ...
    const createTaskButton = page.locator('button:has-text("新建任务"), button:has-text("New Task")').first();
  ...
  test('should assign task to team member', async ({ page }) => {
    ...
    if (await createTaskButton.isVisible()) {
      ...
      const assigneeSelect = page.locator('select[name="assignee"], input[name="assignee"], [role="combobox"]').first();
  ...
  test('should set task due date', async ({ page }) => {
    ...
    if (await createTaskButton.isVisible()) {
      ...
      // Look for date input
      const dateInput = page.locator('input[type="date"], input[name="dueDate"], input[name="deadline"]').first();
  ...
  test('should cancel task creation', async ({ page }) => {
    ...
    if (await createTaskButton.isVisible()) {
      ...
      // Click cancel button
      const cancelButton = page.locator('button:has-text("取消"), button:has-text("Cancel"), button:has-text("关闭"), button[aria-label*="close"]').first();
...
test.describe('Task Management', () => {
  ...
  test('should filter tasks by status', async ({ page }) => {
    ...
    const filterButton = page.locator('button:has-text("筛选"), button:has-text("Filter"), select[name="status"]').first();
  ...
  test('should edit existing task', async ({ page }) => {
    ...
    if (await taskCard.isVisible()) {
      // Click edit button
      const editButton = taskCard.locator('button:has-text("编辑"), button:has-text("Edit"), [aria-label*="edit"]').first();
  ...
  test('should delete task', async ({ page }) => {
    ...
    if (await taskCard.isVisible()) {
      ...
      // Click delete button
      const deleteButton = taskCard.locator('button:has-text("删除"), button:has-text("Delete"), [aria-label*="delete"]').first();
      ...
      if (await deleteButton.isVisible()) {
        ...
        // Confirm deletion
        const confirmButton = page.locator('button:has-text("确认"), button:has-text("Confirm"), button:has-text("Delete")').first();
  ...
  test('should change task status', async ({ page }) => {
    ...
    if (await taskCard.isVisible()) {
      ...
      const statusIndicator = taskCard.locator('.status, [role="button"][aria-label*="status"]').first();
  ...
  test('should add comments to task', async ({ page }) => {
    ...
    if (await taskCard.isVisible()) {
      ...
      const commentInput = page.locator('textarea[placeholder*="评论"], textarea[placeholder*="Comment"], textarea[name="comment"]').first();
...
test.describe('Dashboard Features', () => {
  ...
  test('should display team activity feed', async ({ page }) => {
    const activityFeed = page.locator('.activity-feed, .activity-log, [aria-label*="activity"]').first();
  ...
  test('should export tasks', async ({ page }) => {
    const exportButton = page.locator('button:has-text("导出"), button:has-text("Export"), button[aria-label*="export"]').first();
