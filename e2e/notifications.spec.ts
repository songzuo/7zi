...
test.describe('In-App Notifications', () => {
  ...
  test('should mark notification as read', async ({ page }) => {
    ...
    const unreadNotification = page
      .locator('.notification-item.unread, .notification-item[data-unread="true"]')
      .first()
  ...
  test('should mark all notifications as read', async ({ page }) => {
    ...
    const markAllRead = page.locator(
  ...
  test('should delete notification', async ({ page }) => {
    ...
    const deleteButton = page
      .locator('.notification-item .delete-button, button:has-text("删除")')
      .first()
...
test.describe('Alert System', () => {
  ...
  test('should display system alerts', async ({ page }) => {
    ...
    if (await alertBanner.isVisible({ timeout: 2000 })) {
      ...
      const dismissButton = alertBanner.locator(
        '.close, button:has-text("关闭"), button:has-text("Dismiss")'
      )
...
test.describe('Notification Preferences', () => {
  ...
  test('should configure notification frequency', async ({ page }) => {
    ...
    const frequencySelect = page.locator(
      'select[name="notification-frequency"], .notification-frequency'
    )
