...
export class ContactPage {
  ...
  constructor(page: Page) {
    ...
    this.nameInput = this.contactForm.locator(
    ...
    this.subjectInput = this.contactForm.locator(
      'input[name="subject"], input[placeholder*="主题"], input[placeholder*="Subject"]'
    )
    this.messageTextarea = this.contactForm.locator(
      'textarea[name="message"], textarea[placeholder*="消息"], textarea[placeholder*="Message"]'
    )
