...
function runTests(): TestResult[] {
  ...
  results.push({
    name: 'Very deep object',
    time: time4,
    success: true,
    dataSize: 'depth 50, width 2',
  })
  ...
  results.push({
    name: 'Stress test (1000x)',
    time: time8,
    success: true,
    dataSize: '1000 iterations',
  })
