 ...
 *
 * Tests for WebSocket Room Management functionality
 * Covers: Room creation, joining, leaving, kicking, banning, role management, etc.
 */
...
describe('RoomManager', () => {
  ...
  describe('Callbacks', () => {
    it('should call onUserJoined callback', () => {
      ...
      const callbackManager = new RoomManager(undefined, undefined, { onUserJoined })
    ...
    it('should call onUserLeft callback', () => {
      ...
      const callbackManager = new RoomManager(undefined, undefined, { onUserLeft })
    ...
    it('should call onRoomCreated callback', () => {
      ...
      const callbackManager = new RoomManager(undefined, undefined, { onRoomCreated })
    ...
    it('should call onRoomDestroyed callback', () => {
      ...
      const callbackManager = new RoomManager(undefined, undefined, { onRoomDestroyed })
