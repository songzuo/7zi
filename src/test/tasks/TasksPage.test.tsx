  ...
  describe('edge cases', () => {
    it('should handle multiple rapid task selections', async () => {
      ...
      vi.mocked(useTasksStore).mockImplementation((selector) => {
        const state = {
          tasks: [
            { id: 'task_1', title: 'Task 1', description: '', type: 'development' as const, priority: 'medium' as const, status: 'pending' as const, createdBy: 'user' as const, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), comments: [], history: [] },
            { id: 'task_2', title: 'Task 2', description: '', type: 'development' as const, priority: 'medium' as const, status: 'pending' as const, createdBy: 'user' as const, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), comments: [], history: [] },
          ],
          addTask: vi.fn(),
          updateTask: vi.fn(),
        }
