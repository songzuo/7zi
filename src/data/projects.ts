...
export const projects: Project[] = [
  {
    ...
    title: 'AI 智能电商平台',
    description: '为某知名品牌打造的 AI 驱动电商平台，集成智能推荐、智能客服、智能搜索等功能，大幅提升用户转化率和购物体验。',
    category: 'ai',
    ...
    testimonial: {
      author: '张总',
      role: '电商运营总监',
      content: '7zi Studio 的 AI 解决方案彻底改变了我们的电商运营模式，转化率大幅提升，客户满意度也创历史新高。',
    },
    links: {
  ...
  },
  {
    ...
    title: '金融科技移动应用',
    description: '为金融科技公司开发的移动端应用，支持资产管理、投资分析、智能投顾等功能，安全可靠，用户体验优秀。',
    category: 'app',
    ...
    testimonial: {
      author: '李总',
      role: '产品负责人',
      content: '专业、高效、安全，7zi Studio 团队完美理解金融行业的特殊需求，交付的产品超出了我们的预期。',
    },
    links: {
  ...
  },
  {
    ...
    slug: 'saas-dashboard',
    title: '企业级 SaaS 仪表盘',
    description: '为 SaaS 企业打造的数据可视化仪表盘，支持多维度数据分析、实时监控、自定义报表等功能。',
    category: 'website',
  ...
  },
  {
    ...
    title: '品牌视觉识别系统',
    description: '为创业公司打造的全新品牌视觉识别系统，包括 Logo 设计、品牌色彩、字体规范、应用物料等完整方案。',
    category: 'design',
  ...
  },
  {
    ...
    title: 'AI 内容创作平台',
    description: '基于大语言模型的 AI 内容创作平台，支持文章生成、图片生成、视频脚本创作等多种内容形式。',
    category: 'ai',
  ...
  },
  {
    ...
    title: '健康健身应用',
    description: '集运动追踪、饮食记录、健康数据分析于一体的健康管理应用，帮助用户养成健康生活习惯。',
    category: 'app',
  ...
  },
  {
    ...
    title: '企业官网重设计',
    description: '为传统企业打造的现代化官网，融合品牌调性与数字体验，提升企业在互联网时代的品牌形象。',
    category: 'website',
  ...
  },
  {
    ...
    slug: 'ui-kit-design',
    title: '企业级 UI 组件库',
    description: '为开发团队打造的企业级 UI 组件库，包含 50+ 组件，支持主题定制、暗黑模式、无障碍访问。',
    category: 'design',
