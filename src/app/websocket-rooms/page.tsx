...
const DEMO_MESSAGES: StoredMessage[] = [
  ...
  },
  {
    ...
    reactions: [{ userId: 'user-1', userName: '张三', emoji: '👍', timestamp: new Date() }],
    pinned: false,
    edited: false,
  },
  {
...
export default function WebSocketRoomsDemoPage() {
  ...
  const { setRooms, setMessages, setParticipants, setCurrentUser, addMessage } = useWebSocketStore()
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-4 py-6">
        ...
        <div className="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
          <div className="flex h-[600px]">
            ...
            <div className="flex-1">
              <RoomView onSendMessage={handleSendMessage} onReactMessage={handleReactMessage} />
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 rounded-lg bg-blue-50 p-4 dark:bg-blue-900/20">
          <h3 className="mb-2 font-semibold text-blue-900 dark:text-blue-100">使用说明</h3>
