...
vi.mock('lucide-react', () => ({
  ...
  Bell: () => <div data-testid="bell">Bell</div>,
...
describe('Performance Dashboard Integration', () => {
  ...
  describe('Dashboard Rendering', () => {
    it('should render the dashboard with metrics', async () => {
      ...
      await waitFor(() => {
        // Just check that dashboard renders without crashing
  ...
  describe('User Interactions', () => {
    ...
    it('should allow refreshing data', async () => {
      ...
      await waitFor(
        () => {
          // Use getAllByText and take first one
          const refreshElements = screen.getAllByText(/refresh/i)
      ...
      const refreshButton = screen
        .getAllByRole('button')
        .find(btn => btn.textContent?.toLowerCase().includes('refresh'))
      if (refreshButton) {
    ...
    it('should allow acknowledging alerts', async () => {
      ...
      await waitFor(
        () => {
          // Check for acknowledge buttons (there may be multiple)
