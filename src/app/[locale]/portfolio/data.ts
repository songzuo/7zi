...
export const projects: Project[] = [
  {
    ...
    titleZh: 'AI 智能客服平台',
    description: 'An intelligent customer service system based on LLM, supporting multi-turn conversations, intent recognition, and knowledge base retrieval, helping enterprises improve customer service efficiency by 300%.',
    descriptionZh: '基于大语言模型的智能客服系统，支持多轮对话、意图识别、知识库检索，帮助企业提升客服效率 300%。',
    category: 'ai',
  ...
  },
  {
    ...
    titleZh: '时尚电商网站',
    description: 'High-end fashion brand e-commerce website with modern design, multi-language and multi-currency support, integrated intelligent recommendation system, conversion rate increased by 60%.',
    descriptionZh: '高端时尚品牌电商网站，采用现代化设计，支持多语言、多货币，集成智能推荐系统，转化率提升 60%。',
    category: 'website',
  ...
  },
  {
    ...
    titleZh: '健身追踪应用',
    description: 'Cross-platform fitness tracking app with workout logging, diet management, and social sharing, with 100K+ active users.',
  ...
  },
  {
    ...
    titleZh: '科技公司品牌设计',
    description: 'Complete brand identity for a tech startup, including logo design, visual identity system, and marketing materials.',
  ...
  },
  {
    ...
    titleZh: '房地产交易平台',
    description: 'Comprehensive real estate platform with property listings, VR tours, and online contract signing, 500K+ monthly active users.',
  ...
  },
  {
    ...
    titleZh: 'AI 内容生成平台',
    description: 'AI-powered content creation platform supporting article, image, and video generation, helping marketing teams increase efficiency by 5x.',
...
export function getRelatedProjects(currentSlug: string, category: ProjectCategory, limit: number = 3): Project[] {
  return projects
