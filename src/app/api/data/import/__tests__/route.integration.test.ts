...
vi.mock('@/lib/data-import-export', async () => {
  const actual = await vi.importActual<typeof import('@/lib/data-import-export')>(
  ...
  describe('POST /api/data/import - Import Modes', () => {
    it('should import in insert mode', async () => {
      ...
      const importResult = {
        ...
        stats: {
          totalRows: 1,
          tables: { agents: { inserted: 1, updated: 0, skipped: 0, errors: 0 } },
        },
        errors: [],
        importedAt: '2024-01-01T00:00:00.000Z',
      }
    ...
    it('should import in update mode', async () => {
      ...
      const importResult = {
        ...
        stats: {
          totalRows: 1,
          tables: { agents: { inserted: 0, updated: 1, skipped: 0, errors: 0 } },
        },
        errors: [],
        importedAt: '2024-01-01T00:00:00.000Z',
      }
  ...
  describe('POST /api/data/import - Additional Options', () => {
    it('should support skipDuplicates option', async () => {
      ...
      const importResult = {
        ...
        stats: {
          totalRows: 1,
          tables: { agents: { inserted: 0, updated: 0, skipped: 1, errors: 0 } },
        },
        errors: [],
        importedAt: '2024-01-01T00:00:00.000Z',
      }
