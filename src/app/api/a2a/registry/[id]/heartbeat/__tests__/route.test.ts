...
describe('/api/a2a/registry/[id]/heartbeat', () => {
  ...
  describe('POST request - update heartbeat', () => {
    it('should update heartbeat for existing agent', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/a2a/registry/agent-123/heartbeat', {
        method: 'POST',
    ...
    it('should update agent status when provided', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/a2a/registry/agent-456/heartbeat', {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
    ...
    it('should update agent load when provided', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/a2a/registry/agent-789/heartbeat', {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
    ...
    it('should update both status and load', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/a2a/registry/agent-abc/heartbeat', {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
  ...
  describe('agent not found', () => {
    it('should return 404 for non-existent agent', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/a2a/registry/non-existent/heartbeat', {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
  ...
  describe('parameter validation', () => {
    it('should handle special characters in id', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/a2a/registry/agent-123_abc@xyz/heartbeat', {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
    ...
    it('should handle very long id', async () => {
      ...
      const request = createMockNextRequest(`http://localhost:3000/api/a2a/registry/${longId}/heartbeat`, {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
    ...
    it('should handle numeric id', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/a2a/registry/12345/heartbeat', {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
