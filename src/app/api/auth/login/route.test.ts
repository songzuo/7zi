...
describe('POST /api/auth/login', () => {
  ...
  describe('authentication flow', () => {
    it('should authenticate user with valid credentials', async () => {
      ...
      expect(setAuthCookies).toHaveBeenCalledWith(expect.any(NextResponse), mockToken, null, false)
    })
  ...
  describe('error handling', () => {
    ...
    it('should handle unexpected errors', async () => {
      ...
      expect(createErrorResponse).toHaveBeenCalledWith(new Error('Database connection failed'))
    })
  })
  ...
  describe('response format', () => {
    ...
    it('should set auth cookies on successful response', async () => {
      ...
      expect(setAuthCookies).toHaveBeenCalledWith(mockResponse, 'mock-token', null, undefined)
    })
  })
})
