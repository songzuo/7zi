...
describe('/api/performance/metrics', () => {
  ...
  describe('GET request - retrieve metrics', () => {
    ...
    it('should filter by route', async () => {
      const request = createMockNextRequest(
        'http://localhost:3000/api/performance/metrics?route=/dashboard'
      )
      const response = await GET(request)
      const data = await response.json()
    ...
    it('should filter by metric name', async () => {
      const request = createMockNextRequest(
        'http://localhost:3000/api/performance/metrics?metric=LCP'
      )
      const response = await GET(request)
      const data = await response.json()
    ...
    it('should filter by rating', async () => {
      const request = createMockNextRequest(
        'http://localhost:3000/api/performance/metrics?rating=good'
      )
      const response = await GET(request)
      const data = await response.json()
    ...
    it('should filter by time range', async () => {
      const request = createMockNextRequest(
        'http://localhost:3000/api/performance/metrics?startTime=0&endTime=9999999999999'
      )
      const response = await GET(request)
      const data = await response.json()
    ...
    it('should respect limit parameter', async () => {
      const request = createMockNextRequest(
        'http://localhost:3000/api/performance/metrics?limit=10'
      )
      const response = await GET(request)
      const data = await response.json()
    ...
    it('should handle multiple query parameters', async () => {
      const request = createMockNextRequest(
        'http://localhost:3000/api/performance/metrics?route=/dashboard&metric=LCP&rating=good&limit=50'
      )
      const response = await GET(request)
      const data = await response.json()
  ...
  describe('DELETE request - clear metrics', () => {
    ...
    it('should clear metrics before timestamp', async () => {
      const request = createMockNextRequest(
        'http://localhost:3000/api/performance/metrics?before=1710712800000',
        {
          method: 'DELETE',
        }
      )
    ...
    it('should handle invalid before timestamp', async () => {
      const request = createMockNextRequest(
        'http://localhost:3000/api/performance/metrics?before=invalid',
        {
          method: 'DELETE',
        }
      )
    ...
    it('should handle zero timestamp', async () => {
      const request = createMockNextRequest(
        'http://localhost:3000/api/performance/metrics?before=0',
        {
          method: 'DELETE',
        }
      )
  ...
  describe('statistics', () => {
    ...
    it('should include all stat properties', async () => {
      ...
      await POST(
        createMockNextRequest('http://localhost:3000/api/performance/metrics', {
          method: 'POST',
          headers: { 'content-type': 'application/json' },
          body: postBody,
        })
