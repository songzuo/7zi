...
describe('GET /api/user/preferences', () => {
  ...
  describe('边界条件测试', () => {
    it('应该处理特殊字符的 user_id', async () => {
      ...
      const request = new NextRequest('http://localhost/api/user/preferences?user_id=user%40test.com', {
        method: 'GET',
      });
    ...
    it('应该处理非常长的 user_id', async () => {
      ...
      const request = new NextRequest(`http://localhost/api/user/preferences?user_id=${longUserId}`, {
        method: 'GET',
      });
...
describe('POST /api/user/preferences', () => {
  ...
  describe('正常请求测试', () => {
    it('应该成功创建用户偏好设置', async () => {
      const { getUserPreferences, createUserPreferences } = await import('@/lib/db/user-preferences');
...
describe('PUT /api/user/preferences', () => {
  ...
  describe('正常请求测试', () => {
    it('应该成功更新用户偏好设置', async () => {
      const { getUserPreferences, updateUserPreferences } = await import('@/lib/db/user-preferences');
