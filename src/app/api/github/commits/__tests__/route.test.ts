...
describe('GET /api/github/commits', () => {
  ...
  describe('正常请求测试', () => {
    ...
    it('应该支持自定义 per_page 参数', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&per_page=10',
        {
          method: 'GET',
        }
      )
    ...
    it('应该支持自定义 page 参数', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&page=3',
        {
          method: 'GET',
        }
      )
    ...
    it('应该支持 sha 参数过滤', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&sha=def456',
        {
          method: 'GET',
        }
      )
    ...
    it('应该支持 path 参数过滤', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&path=src/app',
        {
          method: 'GET',
        }
      )
    ...
    it('应该支持 since 参数过滤', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&since=2024-01-01T00:00:00Z',
        {
          method: 'GET',
        }
      )
    ...
    it('应该支持 until 参数过滤', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&until=2024-01-31T00:00:00Z',
        {
          method: 'GET',
        }
      )
  ...
  describe('输入验证测试', () => {
    ...
    it('per_page 小于 1 应该返回 400', async () => {
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&per_page=0',
        {
          method: 'GET',
        }
      )
    ...
    it('per_page 大于 100 应该返回 400', async () => {
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&per_page=101',
        {
          method: 'GET',
        }
      )
    ...
    it('page 小于 1 应该返回 400', async () => {
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&page=0',
        {
          method: 'GET',
        }
      )
    ...
    it('page 为负数应该返回 400', async () => {
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&page=-1',
        {
          method: 'GET',
        }
      )
    ...
    it('per_page 为非数字应该返回 400', async () => {
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&per_page=abc',
        {
          method: 'GET',
        }
      )
    ...
    it('page 为非数字应该返回 400', async () => {
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&page=abc',
        {
          method: 'GET',
        }
      )
    ...
    it('应该允许 per_page 为边界值 1', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&per_page=1',
        {
          method: 'GET',
        }
      )
    ...
    it('应该允许 per_page 为边界值 100', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&per_page=100',
        {
          method: 'GET',
        }
      )
  ...
  describe('错误处理测试', () => {
    it('应该处理 GitHub 404 错误（仓库不存在）', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=nonexistent&repo=repo',
        {
          method: 'GET',
        }
      )
  ...
  describe('边界条件测试', () => {
    ...
    it('应该处理特殊字符的 owner 和 repo', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test--user&repo=my--repo',
        {
          method: 'GET',
        }
      )
    ...
    it('应该处理带特殊字符的 sha', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&sha=abc123def456',
        {
          method: 'GET',
        }
      )
    ...
    it('应该处理带斜杠的 path', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&path=src/app/page.tsx',
        {
          method: 'GET',
        }
      )
    ...
    it('应该处理带特殊字符的 path', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&path=src/app%20test/page.tsx',
        {
          method: 'GET',
        }
      )
    ...
    it('应该处理 ISO 8601 日期格式的 since', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/github/commits?owner=test&repo=repo&since=2024-01-01T00:00:00.000Z',
        {
          method: 'GET',
        }
      )
