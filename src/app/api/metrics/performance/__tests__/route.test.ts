...
import { getApiPerformanceReport, clearApiPerformanceData } from '@/lib/middleware/api-performance'
import { getRateLimitStats, clearAllRateLimits } from '@/lib/middleware/rate-limit'
// Mock dependencies
vi.mock('@/lib/logger', () => ({
  logger: {
    error: vi.fn(),
