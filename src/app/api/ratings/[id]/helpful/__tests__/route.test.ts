...
describe('/api/ratings/[id]/helpful', () => {
  ...
  describe('POST request - mark as helpful', () => {
    it('should mark rating as helpful', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/ratings/rating-123/helpful', {
        method: 'POST',
    ...
    it('should mark rating as not helpful', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/ratings/rating-456/helpful', {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
    ...
    it('should reject missing helpful parameter', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/ratings/rating-789/helpful', {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
    ...
    it('should reject non-boolean helpful parameter', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/ratings/rating-abc/helpful', {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
    ...
    it('should reject null helpful parameter', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/ratings/rating-xyz/helpful', {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
  ...
  describe('rating not found', () => {
    it('should return 404 for non-existent rating', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/ratings/non-existent/helpful', {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
  ...
  describe('parameter validation', () => {
    ...
    it('should handle special characters in id', async () => {
      ...
      const request = createMockNextRequest('http://localhost:3000/api/ratings/rating-123_abc@xyz/helpful', {
        method: 'POST',
        headers: { 'content-type': 'application/json' },
        body: requestBody,
      });
