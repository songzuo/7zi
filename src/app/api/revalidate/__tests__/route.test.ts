...
describe('/api/revalidate', () => {
  ...
  describe('GET request - revalidate by query params', () => {
    it('should revalidate by path with valid secret', async () => {
      const request = createMockNextRequest('http://localhost:3000/api/revalidate?path=/dashboard&secret=test-secret');
    ...
    it('should revalidate by tag with valid secret', async () => {
      const request = createMockNextRequest('http://localhost:3000/api/revalidate?tag=dashboard&secret=test-secret');
    ...
    it('should revalidate by both path and tag', async () => {
      const request = createMockNextRequest('http://localhost:3000/api/revalidate?path=/home&tag=home&secret=test-secret');
    ...
    it('should reject invalid secret', async () => {
      const request = createMockNextRequest('http://localhost:3000/api/revalidate?path=/dashboard&secret=wrong-secret');
    ...
    it('should handle no path or tag parameters', async () => {
      const request = createMockNextRequest('http://localhost:3000/api/revalidate?secret=test-secret');
    ...
    it('should return JSON content type', async () => {
      const request = createMockNextRequest('http://localhost:3000/api/revalidate?path=/test&secret=test-secret');
  ...
  describe('edge cases', () => {
    ...
    it('should handle both POST and GET consistently', async () => {
      ...
      const getRequest = createMockNextRequest('http://localhost:3000/api/revalidate?path=/test&secret=test-secret');
