...
const VARIANT_CONFIG: Record<ButtonVariant, string> = {
  ...
  outline:
    'border-2 border-zinc-300 dark:border-zinc-600 text-zinc-700 dark:text-zinc-300 hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 focus:ring-blue-500',
  ghost:
  ...
  return (
    <button
      className={cn(
        ...
        'focus:ring-2 focus:ring-offset-2 focus:outline-none dark:focus:ring-offset-zinc-900',
