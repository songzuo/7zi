...
export function StatsCard({
  ...
  return (
    ...
    >
      ...
      <div 
        className={`
          absolute inset-0 bg-gradient-to-br ${styles.accent}
      ...
      <div className="relative p-5">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <span className={`text-sm font-medium ${styles.subtextColor}`}>
            {title}
          </span>
        </div>
        ...
        {/* Trend Indicator */}
        {trend && trendValue && (
          <div className={`flex items-center gap-1 mt-2 text-sm ${trendStyles}`}>
            <span>{trendIcon}</span>
