...
vi.mock('lucide-react', () => ({
  TrendingUp: ({ className }: { className: string }) => (
    <svg className={className} data-testid="trending-up" />
  ),
  TrendingDown: ({ className }: { className: string }) => (
    <svg className={className} data-testid="trending-down" />
  ),
  Minus: ({ className }: { className: string }) => (
    <svg className={className} data-testid="minus" />
  ),
  Calendar: ({ className }: { className: string }) => (
    <svg className={className} data-testid="calendar" />
  ),
  ChevronDown: ({ className }: { className: string }) => (
    <svg className={className} data-testid="chevron-down" />
  ),
  Check: ({ className }: { className: string }) => (
    <svg className={className} data-testid="check" />
  ),
  Filter: ({ className }: { className: string }) => (
    <svg className={className} data-testid="filter" />
  ),
  X: ({ className }: { className: string }) => <svg className={className} data-testid="x" />,
  ChevronUp: ({ className }: { className: string }) => (
    <svg className={className} data-testid="chevron-up" />
  ),
  Download: ({ className }: { className: string }) => (
    <svg className={className} data-testid="download" />
  ),
  Activity: ({ className }: { className: string }) => (
    <svg className={className} data-testid="activity" />
  ),
  LineChart: ({ className }: { className: string }) => (
    <svg className={className} data-testid="line-chart-icon" />
  ),
  PieChart: ({ className }: { className: string }) => (
    <svg className={className} data-testid="pie-chart-icon" />
  ),
  BarChart3: ({ className }: { className: string }) => (
    <svg className={className} data-testid="bar-chart3" />
  ),
}))
...
describe('DateRangePicker', () => {
  ...
  it('should render with selected range', () => {
    render(<DateRangePicker selectedRange={mockTimeRange} onChange={mockOnChange} locale="en" />)

    expect(screen.getByText('Last 7 Days')).toBeInTheDocument()
  })

  it('should render Chinese labels', () => {
    render(<DateRangePicker selectedRange={mockTimeRange} onChange={mockOnChange} locale="zh" />)
  ...
  it('should show date inputs when custom is selected', async () => {
    render(<DateRangePicker selectedRange="week" onChange={mockOnChange} locale="en" />)
  ...
  it('should apply custom range', async () => {
    render(<DateRangePicker selectedRange="custom" onChange={mockOnChange} locale="en" />)
...
describe('FilterPanel', () => {
  ...
  it('should render filter sections', () => {
    render(<FilterPanel filters={mockFilters} onFiltersChange={mockOnFiltersChange} locale="en" />)
  ...
  it('should render Chinese labels', () => {
    render(<FilterPanel filters={mockFilters} onFiltersChange={mockOnFiltersChange} locale="zh" />)
