...
vi.mock('lucide-react', () => ({
  ...
  LineChart: ({ className }: { className?: string }) => <div data-testid="line-chart-icon" className={className} />,
  PieChart: ({ className }: { className?: string }) => <div data-testid="pie-chart-icon" className={className} />,
