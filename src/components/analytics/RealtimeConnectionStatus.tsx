...
export const RealtimeConnectionStatus: React.FC<RealtimeConnectionStatusProps> = ({
  ...
  return (
    <div className={`space-y-3 ${className}`}>
      {/* Status Badge */}
      <div className={`flex items-center justify-between rounded-lg border p-4 ${statusBgColor}`}>
      ...
      {connection.lastError && connection.status === 'error' && (
        <div className="rounded-lg border border-red-300 bg-red-100 p-3 dark:border-red-700 dark:bg-red-900/30">
      ...
      {/* Details Panel */}
      {showDetails && (
        <div className="grid grid-cols-2 gap-3 rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-800">
          <div className="flex items-center gap-2">
