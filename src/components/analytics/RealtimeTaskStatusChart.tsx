...
export const RealtimeTaskStatusChart: React.FC<RealtimeTaskStatusChartProps> = ({
  ...
  return (
    <div
      className={`overflow-hidden rounded-lg border border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-800 ${className}`}
    >
      {/* Header */}
              ...
              return (
                <div key={status} className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div
                      className={`rounded p-1.5 ${config.bgColor.replace('500', '100 dark:bg-opacity-20')}`}
                    >
