...
describe('MemberCard', () => {
  ...
  describe('选择模式', () => {
    it('在选择模式下应该显示复选框', () => {
      const { container } = render(<MemberCard member={mockMember} isSelectionMode />)
    ...
    it('选中时应该显示蓝色复选框', () => {
      const { container } = render(<MemberCard member={mockMember} isSelectionMode isSelected />)
  ...
  describe('点击交互', () => {
    it('非选择模式下点击应该调用 onClick 回调', () => {
      const onClick = vi.fn()
      const { container } = render(<MemberCard member={mockMember} onClick={onClick} />)
    ...
    it('选择模式下点击应该调用 onSelect 而不是 onClick', () => {
      ...
      const onSelect = vi.fn()
      const { container } = render(
        <MemberCard member={mockMember} isSelectionMode onClick={onClick} onSelect={onSelect} />
      )
