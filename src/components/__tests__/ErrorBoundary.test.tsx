...
describe('ErrorBoundary', () => {
  ...
  describe('基本渲染', () => {
    it('应该渲染错误标题', () => {
      ...
      render(<ErrorBoundary error={error} reset={mockReset} title="测试错误" />)
  ...
  describe('重试功能', () => {
    ...
    it('重试失败应该记录错误', async () => {
      ...
      await waitFor(() => {
        ...
        // In development mode, console.error is called with '重试失败:'
        // In test mode, it might not be called, so we check for reset being called instead
      })

      // The key assertion: reset was called
      expect(failingReset).toHaveBeenCalled()
    ...
    it('重试按钮在重试期间应该禁用', async () => {
      ...
      render(<ErrorBoundary error={error} reset={slowReset} />)
  ...
  describe('导航功能', () => {
    it('点击返回首页应该跳转到根路径', () => {
      ...
      render(<ErrorBoundary error={error} reset={mockReset} showHomeButton />)
  ...
  describe('按钮显示控制', () => {
    it('showReset=false 应该不显示重试按钮', () => {
      ...
      render(<ErrorBoundary error={error} reset={mockReset} showReset={false} />)
    ...
    it('showHomeButton=false 应该不显示返回首页按钮', () => {
      ...
      render(<ErrorBoundary error={error} reset={mockReset} showHomeButton={false} />)
