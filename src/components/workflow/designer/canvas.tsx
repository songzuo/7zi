  ...
  (
    ...
    const handleCanvasMouseDown = useCallback(
      (e: React.MouseEvent) => {
        ...
        } else if (e.button === 0 && !(e.target as HTMLElement | null)?.closest('[data-node-id]')) {
          // 点击空白区域取消选择
    ...
    return (
      <div className={cn('relative h-full w-full overflow-hidden bg-gray-50', className)}>
        ...
        {/* 缩放指示器 */}
        <div className="absolute right-4 bottom-4 rounded bg-white px-2 py-1 text-sm text-gray-600 shadow">
