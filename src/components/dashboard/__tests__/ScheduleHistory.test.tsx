...
const generateMockTasks = (count: number) => {
  return Array.from({ length: count }, (_, i) => {
    ...
    const baseTask = status === 'failed' ? createFailedTask(`${i}`, `Error ${i}`) : createCompletedTask(`${i}`);
    return {
      ...baseTask,
...
describe('ScheduleHistory Component', () => {
  ...
  describe('Time Formatting', () => {
    it('should show "今天" for today\'s tasks', () => {
      mockStoreState.tasks = [
        createCompletedTask('1', { completedAt: Date.now() - 1000 }),
      ];
      render(<ScheduleHistory />);
    ...
    it('should show "昨天" for yesterday\'s tasks', () => {
      mockStoreState.tasks = [
        createCompletedTask('1', { completedAt: Date.now() - 86400000 }),
      ];
      render(<ScheduleHistory />);
  ...
  describe('Error Handling', () => {
    ...
    it('should handle tasks without completedAt', () => {
      mockStoreState.tasks = [
        createCompletedTask('1', { completedAt: undefined }),
      ];
  ...
  describe('Edge Cases', () => {
    it('should handle very long task title', () => {
      ...
      mockStoreState.tasks = [
        createCompletedTask('1', { title: longTitle }),
      ];
    ...
    it('should handle Unicode characters', () => {
      mockStoreState.tasks = [
        createCompletedTask('1', { title: '🎉 庆祝任务 🎊' }),
      ];
