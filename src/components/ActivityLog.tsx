...
export const ActivityLog: FC<ActivityLogProps> = ({ activities }) => {
  ...
  return (
    <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 overflow-hidden">
      ...
      {/* 底部 */}
      {activities.length > 0 && (
        <div className="px-6 py-3 border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50 text-xs text-zinc-500 dark:text-zinc-400 flex items-center gap-2">
...
const ActivityItemCardBase: React.FC<ActivityItemCardProps> = ({ activity, icon, colorClass, label }) => {
  return (
