...
if (ko.team.members.designer.description.includes('を作成し')) {
  ko.team.members.designer.description = '아름답고 사용자 친화적인 인터페이스를 만들어 우수한 사용자 경험 디자인을 제공합니다.';
...
if (ko.about.timeline && ko.about.timeline.description === 'From startup to growth, every step forward with our clients') {
...
if (ko.about.partners && ko.about.partners.count === '{count} companies have chosen to work with us') {
...
if (ko.about.cta && ko.about.cta.description === "Let's build your digital project together and create infinite possibilities") {
...
if (ko.errors.forbidden && ko.errors.forbidden.solution && ko.errors.forbidden.solution.startsWith(' ')) {
...
if (ko.about.values && ko.about.values.items && ko.about.values.items.innovation.title === '혁신驱动') {
...
if (es.about.intro.p3 && es.about.intro.p3.includes("Whether it's")) {
  es.about.intro.p3 = 'Ya sea desarrollo web, diseño de marca, optimización SEO o marketing de contenidos, 7zi Studio le ofrece soluciones digitales integrales.';
...
if (es.about.timeline && es.about.timeline.description === 'From startup to growth, every step forward with our clients') {
  es.about.timeline.description = 'Desde el inicio hasta el crecimiento, cada paso adelante con nuestros clientes';
...
if (es.about.partners && es.about.partners.count === '{count} companies have chosen to work with us') {
...
if (es.about.cta && es.about.cta.description === "Let's build your digital project together and create infinite possibilities") {
  es.about.cta.description = 'Construyamos juntos tu proyecto digital y creemos posibilidades infinitas';
...
if (es.errors.unauthorized && es.errors.unauthorized.solution.includes('Please sign in')) {
  es.errors.unauthorized.solution = 'Por favor inicie sesión para continuar, o contacte soporte si cree que esto es un error.';
...
if (es.team.members.designer.description === 'Creates beautiful and user-friendly interfaces, providing excellent user experience design.') {
  es.team.members.designer.description = 'Crea interfaces hermosas y fáciles de usar, proporcionando excelente diseño de experiencia de usuario.';
...
if (es.contact.hero.description && es.contact.hero.description.includes("We're always ready")) {
  es.contact.hero.description = '¿Tienes preguntas o ideas de colaboración? Siempre estamos listos para servirte';
...
if (es.errors.general && es.errors.general.support && es.errors.general.support.includes('If the problem continues')) {
...
if (ja.about.intro.p1.startsWith('は革新的な')) {
  ja.about.intro.p1 = '7zi Studioは革新的なデジタルスタジオです。チームの概念を再定義しました — 11の専門的なAIエージェントから成り、各々が専門性を活用してさまざまなデジタルプロジェクトを協力的に完了させます。';
...
if (ja.about.hero.description.includes('年中无公害')) {
  ja.about.hero.description = 'チームコラボレーションを再定義 — 11のAIエージェントによるインテリジェントチーム、24時間365日でデジタル価値を創出';
...
if (ja.contact.hero.description.includes('おありますか')) {
  ja.contact.hero.description = 'ご質問やパートナーシップのご提案はおありですか？常時ご対応いたします';
...
if (ja.errors.unauthorized && ja.errors.unauthorized.solution.includes('Please sign in')) {
  ja.errors.unauthorized.solution = '続行するにはサインインするか、エラーと思われる場合はサポートまでご連絡ください。';
  fixes.ja.push('errors.unauthorized.solution - Translated from English to Japanese');
}

// Fix: errors.general.support - English "If the problem continues, please contact"
if (ja.errors.general && ja.errors.general.support && ja.errors.general.support.includes('If the problem continues')) {
