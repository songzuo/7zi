 ...
 */
export function convertToCSV(data: CSVData, columns?: CSVColumn[]): string {
 ...
 */
export function exportToCSV(data: CSVData, filename: string, columns?: CSVColumn[]): void {
 ...
 */
export async function copyCSVToClipboard(data: CSVData, columns?: CSVColumn[]): Promise<void> {
  try {
    const csv = convertToCSV(data, columns)
