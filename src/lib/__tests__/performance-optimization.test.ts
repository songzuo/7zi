...
describe('performance-optimization.ts', () => {
  ...
  describe('measureAsync', () => {
    ...
    it('should clear marks after measurement', async () => {
      ...
      expect(mockWindow.performance.clearMarks).toHaveBeenCalledWith(['test-async-start', 'test-async-end']);
    });
  ...
  describe('measureSync', () => {
    ...
    it('should clear marks after measurement', () => {
      ...
      expect(mockWindow.performance.clearMarks).toHaveBeenCalledWith(['test-sync-start', 'test-sync-end']);
    });
