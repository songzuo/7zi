    ...
    it('should match wildcard path', async () => {
      const wildcardConfig: BudgetConfig = {
        budgets: [
          {
            path: '/dashboard/*',
            timings: [{ metric: 'LCP', budget: 3500, tolerance: 0.1 }],
          },
        ],
      }
    ...
    it('should handle TBT metric', async () => {
      const config: BudgetConfig = {
        budgets: [
          {
            path: '/',
            timings: [{ metric: 'TBT', budget: 300, tolerance: 0.2 }],
          },
        ],
      }
    ...
    it('should handle TTFB metric', async () => {
      const config: BudgetConfig = {
        budgets: [
          {
            path: '/',
            timings: [{ metric: 'TTFB', budget: 800, tolerance: 0.2 }],
          },
        ],
      }
    ...
    it('should handle FCP metric', async () => {
      const config: BudgetConfig = {
        budgets: [
          {
            path: '/',
            timings: [{ metric: 'FCP', budget: 1800, tolerance: 0.15 }],
          },
        ],
      }
