...
describe('Enhanced search functionality', () => {
  ...
  describe('Field weights', () => {
    it('should apply higher weight to title field', () => {
      ...
      const statusMatch = results.find(r => r.item.status === 'open' && !r.item.title.includes('open'));
...
describe('Apply filters', () => {
  ...
  beforeEach(() => {
    testItems = [
      { id: 1, title: 'Task 1', description: 'Desc 1', status: 'open', priority: 'high', tags: 'bug' },
      { id: 2, title: 'Task 2', description: 'Desc 2', status: 'open', priority: 'low', tags: 'feature' },
      { id: 3, title: 'Task 3', description: 'Desc 3', status: 'closed', priority: 'high', tags: 'bug' },
    ];
...
describe('Apply sort', () => {
  ...
  beforeEach(() => {
    testItems = [
      { id: 3, title: 'Task C', description: 'Desc 3', status: 'open', priority: 'high', tags: 'bug' },
      { id: 1, title: 'Task A', description: 'Desc 1', status: 'open', priority: 'low', tags: 'bug' },
      { id: 2, title: 'Task B', description: 'Desc 2', status: 'closed', priority: 'medium', tags: 'feature' },
    ];
  });
