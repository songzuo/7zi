 ...
 */
export type TaskType = 'BUG' | 'FEATURE' | 'REFACTOR' | 'DOCS' | 'TEST' | 'OTHER';
 ...
 */
export const DEFAULT_RULES: PriorityRulesConfig = {
...
export class TaskPriorityAnalyzer {
   ...
   */
  private calculateTypeScore(type: TaskType): { score: number; reasoning: string[] } {
    const reasoning: string[] = [];
