...
describe('DocumentManager', () => {
  ...
  it('should update document with operation', () => {
    ...
    const updated = documentManager.updateDocument(
      'doc1',
      insertOp,
      'user1',
      'John Doe'
...
describe('CursorManager', () => {
  ...
  it('should update cursor position', () => {
    const cursor = cursorManager.updateCursor(
      'room1',
      'user1',
      'John Doe',
      10
  ...
  it('should generate consistent color for same user', () => {
    const cursor1 = cursorManager.updateCursor(
      'room1',
      'user1',
      'John Doe',
      10
    );
    const cursor2 = cursorManager.updateCursor(
      'room2',
      'user1',
      'John Doe',
      20
...
describe('CollaborationManager', () => {
  ...
  it('should handle document operation', () => {
    const result = collaborationManager.handleOperation(
      'doc1',
      insertOp,
      'user1',
      'John Doe'
  ...
  it('should handle cursor update', () => {
    const cursor = collaborationManager.handleCursorUpdate(
      'room1',
      'user1',
      'John Doe',
      10
  ...
  it('should handle presence update', () => {
    const presence = collaborationManager.handlePresenceUpdate(
      'user1',
      'John Doe',
      'online',
      true
