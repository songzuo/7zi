...
import { ShortcutManager, getShortcutManager, destroyShortcutManager, initShortcutManager } from './shortcut-manager';
...
describe('shortcut-manager', () => {
  ...
  describe('register', () => {
    ...
    it('should throw error for invalid shortcut (missing key)', () => {
      const invalid = { id: 'test', context: 'global', description: 'test', action: () => {} } as any;
      expect(() => manager.register(invalid)).toThrow('Invalid shortcut');
    });
