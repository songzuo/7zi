...
import type { KeyboardShortcut, ShortcutContext, ShortcutManagerConfig, ContextChangeListener, ShortcutTriggerListener } from './shortcut-types';
import { DEFAULT_SHORTCUTS, getShortcutDisplayText } from './shortcut-config';

// Re-export types for backward compatibility
export type { KeyboardShortcut, ShortcutContext, ShortcutManagerConfig, ContextChangeListener, ShortcutTriggerListener } from './shortcut-types';
...
export class ShortcutManager {
  ...
  register(shortcut: KeyboardShortcut): void {
    ...
    this.contextShortcuts.get(customizedShortcut.context)!.set(customizedShortcut.id, customizedShortcut);
  ...
  getActiveShortcuts(): KeyboardShortcut[] {
    ...
    const contextShortcuts = this.currentContext !== 'global'
      ? this.getShortcutsForContext(this.currentContext)
      : [];
