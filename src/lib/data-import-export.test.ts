  ...
  describe('exportToCSV', () => {
    ...
    it('should escape values with commas', () => {
      const data = {
        ...
        tables: ['agents'],
        data: {
          agents: [{ id: 'agent-1', name: 'Agent, With, Commas', type: 'worker' }],
        },
        stats: { totalRows: 1, tables: { agents: 1 } },
        exportedAt: '2024-01-01T00:00:00.000Z',
      }
    ...
    it('should escape values with quotes', () => {
      const data = {
        ...
        tables: ['agents'],
        data: {
          agents: [{ id: 'agent-1', name: 'Agent "With Quotes"', type: 'worker' }],
        },
        stats: { totalRows: 1, tables: { agents: 1 } },
        exportedAt: '2024-01-01T00:00:00.000Z',
      }
    ...
    it('should handle null values', () => {
      const data = {
        ...
        tables: ['agents'],
        data: {
          agents: [{ id: 'agent-1', name: 'Agent 1', description: null }],
        },
        stats: { totalRows: 1, tables: { agents: 1 } },
        exportedAt: '2024-01-01T00:00:00.000Z',
      }
