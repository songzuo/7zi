...
class PerformanceAlertManager {
  ...
  private setSilencePeriod(key: string, level: AlertLevel): void {
    ...
    const levelSilence =
      ALERT_CONFIG.rules.silencePeriod[level as keyof typeof ALERT_CONFIG.rules.silencePeriod]
   ...
   * 获取告警历史
   */
  getHistory(options?: { level?: AlertLevel; metricName?: string; since?: number }): AlertRecord[] {
