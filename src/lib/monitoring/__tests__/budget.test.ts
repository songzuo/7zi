...
describe('PerformanceBudget', () => {
  ...
  describe('Constructor and Budget Management', () => {
    ...
    it('should accept custom budgets', () => {
      const customBudget: BudgetConfig = {
        ...
        category: 'custom',
        enabled: true,
        thresholds: [{ name: 'Custom Metric', value: 100, unit: 'ms', severity: 'warning' }],
      }
    ...
    it('should add budgets correctly', () => {
      const newBudget: BudgetConfig = {
        ...
        category: 'custom',
        enabled: true,
        thresholds: [{ name: 'Test Metric', value: 50, unit: 'ms', severity: 'warning' }],
      }
  ...
  describe('Metric Checking', () => {
    ...
    it('should calculate correct percentage over', () => {
      ...
      const lcpViolation = results.flatMap(r => r.violations).find(v => v.threshold.name === 'LCP')
...
describe('Helper Functions', () => {
  ...
  describe('createBudget', () => {
    it('should create a budget configuration', () => {
      const config = createBudget('Custom Budget', 'A custom budget for testing', 'custom', [
