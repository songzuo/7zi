...
describe('MCP Resource Manager', () => {
  ...
  it('should read a resource', async () => {
    const content = await mcpResourceManager.read('file:///root/.openclaw/workspace/package.json', {
      metadataOnly: true,
    })
  ...
  it('should create and manage subscriptions', async () => {
    const subscriptionId = await mcpResourceManager.subscribe('test-session', { types: ['file'] })
