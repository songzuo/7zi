...
describe('ApprovalRepository', () => {
  ...
  describe('approve', () => {
    ...
    it('should not approve already approved approval', () => {
      ...
      const approved2 = ApprovalRepository.approve(request.id, 'approver-2', 'Approver 2')

      expect(approved2).toBeNull()
    })

    it('should return null when approval does not exist', () => {
      const approved = ApprovalRepository.approve('non-existent-id', 'approver-1', 'Approver 1')
  ...
  describe('reject', () => {
    ...
    it('should not reject already approved approval', () => {
      ...
      const rejected = ApprovalRepository.reject(request.id, 'approver-2', 'Approver 2', 'No')
