...
describe('AdvancedSearchManager', () => {
  ...
  describe('Index management', () => {
    it('should create a search index', () => {
      searchManager.createIndex('tasks', testItems.filter(i => i.type === 'task'));
    ...
    it('should update an existing index', () => {
      ...
      searchManager.updateIndex('tasks', testItems.filter(i => i.type === 'task'));
  ...
  describe('Search within specific index', () => {
    beforeEach(() => {
      searchManager.createIndex('tasks', testItems.filter(i => i.type === 'task'));
      searchManager.createIndex('projects', testItems.filter(i => i.type === 'project'));
    });
