...
export class SimpleEventBus implements ExecutionEventBus {
  ...
  private listeners: Array<(event: Task | Message | TaskStatusUpdateEvent | TaskArtifactUpdateEvent) => void> = [];
  ...
  subscribe(listener: (event: Task | Message | TaskStatusUpdateEvent | TaskArtifactUpdateEvent) => void): void {
    this.listeners.push(listener);
  }

  unsubscribe(listener: (event: Task | Message | TaskStatusUpdateEvent | TaskArtifactUpdateEvent) => void): void {
