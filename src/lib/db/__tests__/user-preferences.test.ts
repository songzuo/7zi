...
describe('user-preferences', () => {
  ...
  describe('initializeUserPreferencesTable', () => {
    ...
    it('should log successful initialization', async () => {
      ...
      expect(logger.info).toHaveBeenCalledWith('User preferences table initialized', {
        category: 'db',
      })
    })
    ...
    it('should handle initialization errors', async () => {
      ...
      const { logger } = await import('../../logger')
      expect(logger.error).toHaveBeenCalledWith('Failed to initialize user preferences table', {
        category: 'db',
        error,
      })
    })
  ...
  describe('getUserPreferences', () => {
    ...
    it('should handle query errors', async () => {
      ...
      const { logger } = await import('../../logger')
      expect(logger.error).toHaveBeenCalledWith('Failed to get user preferences', {
        category: 'db',
        error,
        userId: 'user123',
      })
  ...
  describe('createUserPreferences', () => {
    ...
    it('should log successful creation', async () => {
      ...
      const { logger } = await import('../../logger')
      expect(logger.info).toHaveBeenCalledWith('User preferences created', {
        category: 'db',
        userId: 'user123',
      })
    })
    ...
    it('should handle creation errors', async () => {
      ...
      const { logger } = await import('../../logger')
      expect(logger.error).toHaveBeenCalledWith('Failed to create user preferences', {
        category: 'db',
        error,
        userId: 'user123',
      })
  ...
  describe('updateUserPreferences', () => {
    ...
    it('should update single field', async () => {
      ...
      expect(mockDb.exec).toHaveBeenCalledWith(
        ...
        expect.arrayContaining(['en', expect.any(String), 'user123'])
      )
    ...
    it('should reject when no fields to update', async () => {
      await expect(updateUserPreferences('user123', {})).rejects.toThrow('No fields to update')
    })
    ...
    it('should log successful update', async () => {
      ...
      const { logger } = await import('../../logger')
      expect(logger.info).toHaveBeenCalledWith('User preferences updated', {
        category: 'db',
        userId: 'user123',
        updates: { locale: 'en' },
      })
    ...
    it('should handle update errors', async () => {
      ...
      await expect(updateUserPreferences('user123', { locale: 'en' })).rejects.toThrow(
        'Update failed'
      )
    })
  ...
  describe('deleteUserPreferences', () => {
    it('should delete user preferences', async () => {
      ...
      expect(mockDb.exec).toHaveBeenCalledWith('DELETE FROM user_preferences WHERE user_id = ?', [
        'user123',
      ])
    })
    ...
    it('should log successful deletion', async () => {
      ...
      const { logger } = await import('../../logger')
      expect(logger.info).toHaveBeenCalledWith('User preferences deleted', {
        category: 'db',
        userId: 'user123',
      })
    })
    ...
    it('should handle deletion errors', async () => {
      ...
      const { logger } = await import('../../logger')
      expect(logger.error).toHaveBeenCalledWith('Failed to delete user preferences', {
        category: 'db',
        error,
        userId: 'user123',
      })
