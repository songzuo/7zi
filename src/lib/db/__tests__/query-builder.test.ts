...
describe('QueryBuilder', () => {
  ...
  describe('Constructor', () => {
    ...
    it('should accept initial conditions', () => {
      const conditions: QueryCondition[] = [{ condition: 'status = ?', value: 'active' }]
  ...
  describe('where', () => {
    ...
    it('should chain multiple where calls', () => {
      const query = builder.where('id = ?', 1).where('name = ?', 'John').build()
  ...
  describe('build', () => {
    ...
    it('should build complete query', () => {
      builder.select(['id', 'name']).where('status = ?', 'active').orderBy('id', 'ASC').paginate(10)
  ...
  describe('reset', () => {
    it('should reset builder to initial state', () => {
      builder.where('status = ?', 'active').orderBy('id', 'ASC').paginate(10)
