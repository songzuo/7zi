      ...
      return {
        run: (...params: unknown[]) => {
          try {
            ...
            throw UnifiedAppError.internal(`Database prepare.run failed: ${errorMessage}`, {
              sql,
              params,
            })
          }
        ...
        get: (...params: unknown[]) => {
          try {
            ...
            throw UnifiedAppError.internal(`Database prepare.get failed: ${errorMessage}`, {
              sql,
              params,
            })
          }
        ...
        all: (...params: unknown[]) => {
          try {
            ...
            throw UnifiedAppError.internal(`Database prepare.all failed: ${errorMessage}`, {
              sql,
              params,
            })
          }
