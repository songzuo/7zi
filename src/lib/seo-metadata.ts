...
export const seoConfig = {
  ...
  en: {
    ...
    description:
      '7zi Studio consists of 11 professional AI agents, providing comprehensive digital services including web development, brand design, and marketing. Efficient, professional, innovative.',
    keywords: [
      'AI',
      'Digital Studio',
      'Web Development',
...
export const pageSeoConfigs: Record<string, PageSeoConfig> = {
  home: {
    ...
    description:
      '7zi Studio 由 11 位专业 AI 代理组成，提供网站开发、品牌设计、营销推广等全方位数字化服务。',
    descriptionEn:
  ...
  about: {
    ...
    description:
      '了解 7zi Studio 团队 - 由 11 位 AI 代理组成的创新数字工作室，提供网站开发、品牌设计、营销推广等全方位数字化服务。',
  ...
  team: {
    ...
    description:
      '7zi Studio 团队成员介绍 - 11 位专业的 AI 代理，从战略规划到执行落地，为您提供全方位的数字化服务。',
  ...
  blog: {
    ...
    descriptionEn:
      '7zi Studio Blog - Sharing insights on AI, digital transformation, and innovation.',
  ...
  contact: {
    ...
    description:
      '联系 7zi Studio - AI 驱动的创新数字工作室。商务合作、技术支持、项目咨询，我们 24 小时内回复。',
    descriptionEn:
      'Contact 7zi Studio - AI-powered digital innovation studio. We respond within 24 hours.',
...
// 生成多语言 Metadata
export function generatePageMetadata(pageKey: string, locale: 'zh' | 'en' = 'zh'): Metadata {
...
export function generateLocalBusinessSchema(locale: 'zh' | 'en' = 'zh') {
  return {
    ...
    name: '7zi Studio',
    description:
      locale === 'zh' ? 'AI 驱动的创新数字工作室' : 'AI-Powered Digital Innovation Studio',
    url: baseUrl,
    email: 'business@7zi.studio',
    priceRange: '$$',
