...
describe('Agent Scoring System', () => {
  ...
  const createDecision = (
    taskId: string,
    agentId: string,
    scores?: Partial<ScheduleDecision['scores']>
  ): ScheduleDecision => ({
    taskId,
  ...
  describe('Weight Optimization', () => {
    it('should return null without sufficient data', () => {
      const agents = new Map([['agent1', createMockAgent('agent1', 0.9)]])
    ...
    it('should adjust weights for high performance scenario', () => {
      const agents = new Map([['agent1', createMockAgent('agent1', 0.95)]])
    ...
    it('should adjust weights for low confidence scenario', () => {
      const agents = new Map([['agent1', createMockAgent('agent1', 0.7)]])
  ...
  describe('Weight Adjustment Suggestions', () => {
    it('should suggest adjustments for underperforming agents', () => {
      const agents = new Map([['agent1', createMockAgent('agent1', 0.6)]])
    ...
    it('should suggest adjustments for overperforming agents', () => {
      const agents = new Map([['agent1', createMockAgent('agent1', 0.98)]])
