...
function createMockRequest(url: string, method = 'GET', body?: any): MockNextRequest {
...
function createMockResponse(status = 200, data: any = { success: true }): MockNextResponse {
...
describe('Combined Security Middleware', () => {
  ...
  it('should handle input validation errors', async () => {
    ...
    const secureHandler = withSecurity(handler as any, SecurityConfigs.auth, {
      bodySchema: {
        email: { isEmail: true },
