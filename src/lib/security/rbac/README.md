...
// 记录敏感操作
await logSensitiveOperation('user123', 'update', 'user_profile', 'profile456', {
...
// 记录安全事件
await logSecurityEvent(AuditEventType.UNAUTHORIZED_ACCESS, AuditEventLevel.ERROR, 'user123', {
