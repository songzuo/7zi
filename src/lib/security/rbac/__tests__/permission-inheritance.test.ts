...
describe('PermissionInheritance', () => {
  ...
  describe('计算继承权限', () => {
    it('应该正确计算单个角色的权限（UNION）', () => {
      const result = inheritance.calculateInheritedPermissions(Role.ADMIN, InheritanceStrategy.UNION);
    ...
    it('应该正确计算单个角色的权限（OVERRIDE）', () => {
      const result = inheritance.calculateInheritedPermissions(Role.ADMIN, InheritanceStrategy.OVERRIDE);
    ...
    it('未知角色应该返回空权限', () => {
      const result = inheritance.calculateInheritedPermissions('unknown' as Role, InheritanceStrategy.UNION);
