...
const OUTCOME_COLORS: Record<OutcomeType, { bg: string; text: string; icon: string }> = {
  ...
  successful: { bg: 'bg-green-100 dark:bg-green-900/30', text: 'text-green-700 dark:text-green-400', icon: '✅' },
  failed: { bg: 'bg-red-100 dark:bg-red-900/30', text: 'text-red-700 dark:text-red-400', icon: '❌' },
  manual: { bg: 'bg-purple-100 dark:bg-purple-900/30', text: 'text-purple-700 dark:text-purple-400', icon: '👤' },
};
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className={`px-2 py-1 rounded-md text-xs font-medium ${OUTCOME_COLORS[outcome].bg} ${OUTCOME_COLORS[outcome].text}`}>
      ...
      <div className="p-4 space-y-3">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              ...
              {decision.alternativeAgents.length > 3 && (
                <span className="px-2 py-0.5 bg-gray-200 dark:bg-gray-600 text-gray-600 dark:text-gray-400 rounded text-xs">
                  +{decision.alternativeAgents.length - 3}
                </span>
              )}
            </div>
        ...
        <button
          onClick={onToggle}
          className="w-full mt-2 flex items-center justify-center gap-1.5 text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition-colors"
        >
  ...
  return (
    <div className="flex items-center justify-center gap-2">
      <button
        ...
        className="px-3 py-1.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
        上一页
      </button>
