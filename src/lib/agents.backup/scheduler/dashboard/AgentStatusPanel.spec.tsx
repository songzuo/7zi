...
vi.mock('lucide-react', () => ({
  ...
  TrendingUp: ({ className }: { className?: string }) => <span data-testid="trending-icon" className={className} />,
  ...
  ChevronDown: ({ className }: { className?: string }) => <span data-testid="chevron-down-icon" className={className} />,
  ChevronUp: ({ className }: { className?: string }) => <span data-testid="chevron-up-icon" className={className} />,
}));
