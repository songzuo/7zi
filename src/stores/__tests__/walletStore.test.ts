...
describe('WalletStore', () => {
  ...
  describe('getWallet', () => {
    it('应该返回指定智能体的钱包', () => {
      ...
      initializeWallets([{ id: 'agent-1', name: 'Executor', initialBalance: 500 }])
  ...
  describe('deposit', () => {
    it('应该成功存入金额', async () => {
      ...
      initializeWallets([{ id: 'agent-1', name: 'Executor', initialBalance: 100 }])
  ...
  describe('withdraw', () => {
    ...
    it('应该拒绝余额不足的提取', async () => {
      ...
      initializeWallets([{ id: 'agent-1', name: 'Executor', initialBalance: 50 }])
  ...
  describe('freezeWallet / unfreezeWallet', () => {
    it('应该成功冻结和解冻钱包', () => {
      const { initializeWallets, freezeWallet, unfreezeWallet, getWallet } =
        useWalletStore.getState()

      initializeWallets([{ id: 'agent-1', name: 'Executor' }])
