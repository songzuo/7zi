...
describe('DEFAULT_WALLET_CONFIG', () => {
  ...
  it('should have reasonable default values', () => {
    ...
    expect(DEFAULT_WALLET_CONFIG.maxTransferAmount).toBeGreaterThan(DEFAULT_WALLET_CONFIG.minTransferAmount);
...
describe('Wallet config validation', () => {
  ...
  it('should handle edge cases for transfer amounts', () => {
    expect(DEFAULT_WALLET_CONFIG.minTransferAmount).toBeLessThan(DEFAULT_WALLET_CONFIG.maxTransferAmount);
  });
