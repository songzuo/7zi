...
describe('useFetch', () => {
  ...
  describe('revalidateOnFocus', () => {
    it('当 revalidateOnFocus 为 true 时，窗口获得焦点应该重新获取', async () => {
      ...
      const { result } = renderHook(() => useFetch('/api/test', { revalidateOnFocus: true }))
    ...
    it('当 revalidateOnFocus 为 false 时，窗口获得焦点不应该重新获取', async () => {
      ...
      const { result } = renderHook(() => useFetch('/api/test', { revalidateOnFocus: false }))
  ...
  describe('revalidateInterval', () => {
    it('应该按间隔自动重新获取数据', async () => {
      ...
      const { result } = renderHook(() => useFetch('/api/test', { revalidateInterval: 5000 }))
    ...
    it('当 revalidateInterval 为 0 时不应该自动重新获取', async () => {
      ...
      const { result } = renderHook(() => useFetch('/api/test', { revalidateInterval: 0 }))
  ...
  describe('清理', () => {
    it('组件卸载时应该清理 focus 事件监听器', async () => {
      ...
      const { unmount } = renderHook(() => useFetch('/api/test', { revalidateOnFocus: true }))
    ...
    it('组件卸载时应该清理 interval', async () => {
      ...
      const { unmount } = renderHook(() => useFetch('/api/test', { revalidateInterval: 1000 }))
