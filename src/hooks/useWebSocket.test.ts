...
describe('useWebSocket', () => {
  ...
  describe('initialization', () => {
    ...
    it('should create socket with custom config', () => {
      ...
      expect(io).toHaveBeenCalledWith('ws://custom:4000', expect.objectContaining({
  ...
  describe('room management', () => {
    it('should join room successfully', async () => {
      ...
      expect(mockSocket.emit).toHaveBeenCalledWith('joinRoom', expect.objectContaining({
        roomId: 'room-123',
        type: 'document',
        documentId: 'doc-456',
        name: 'Test Room',
  ...
  describe('heartbeat', () => {
    it('should send heartbeat at interval', async () => {
      const { result } = renderHook(() => useWebSocket({ autoConnect: false, heartbeatInterval: 1000 }));
  ...
  describe('cleanup', () => {
    ...
    it('should clear intervals on unmount', () => {
      const { unmount } = renderHook(() => useWebSocket({ autoConnect: true, heartbeatInterval: 1000 }));
