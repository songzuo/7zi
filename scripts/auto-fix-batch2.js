...
const fixes = [
  ...
  },
  {
    ...
    replacements: [{ old: 'const generateAlertId = ', new: 'const _generateAlertId = ' }],
  },
  {
    file: 'src/app/api/performance/clear/route.ts',
    replacements: [{ old: 'const createErrorResponse = ', new: 'const _createErrorResponse = ' }],
  },
  {
  ...
  },
  {
    ...
    replacements: [{ old: 'const logger = ', new: 'const _logger = ' }],
  },
  {
    file: 'src/app/api/ratings/route.ts',
    replacements: [{ old: 'const images = ', new: 'const _images = ' }],
  },
  {
  ...
  },
  {
    ...
    replacements: [{ old: 'const getAllRolesWithCount = ', new: 'const _getAllRolesWithCount = ' }],
  },
  {
  ...
  },
  {
    ...
    replacements: [{ old: 'const baseUrl = ', new: 'const _baseUrl = ' }],
  },
  {
