...
const fixes = [
  {
    ...
    replacements: [
      { old: 'const pendingTasks = ', new: 'const _pendingTasks = ' },
    ]
  },
  {
  ...
  },
  {
    ...
    replacements: [
      { old: 'const handleCategoryChange = ', new: 'const _handleCategoryChange = ' },
    ]
  },
  {
    file: 'src/app/[locale]/portfolio/components/PortfolioGrid.tsx',
    replacements: [
      { old: '{ startTransition, }', new: '{ }' },
    ]
  },
  {
    file: 'src/app/[locale]/settings/page.tsx',
    replacements: [
      { old: 'setBackupRefreshTrigger', new: '_setBackupRefreshTrigger' },
    ]
  },
  {
    file: 'src/app/api/a2a/jsonrpc/route.ts',
    replacements: [
      { old: 'const handler = ', new: 'const _handler = ' },
    ]
  },
  {
  ...
  },
  {
    ...
    replacements: [
      { old: 'const authHeader = ', new: 'const _authHeader = ' },
    ]
  },
  {
  ...
  },
  {
    ...
    replacements: [
      { old: 'import { ApiError }', new: 'import { ApiError as _ApiError }' },
    ]
  },
  {
  ...
  try {
    ...
    if (removeImports) {
      removeImports.forEach(imp => {
        const importRegex = new RegExp(`import\\s+\\{[^}]*\\b${imp}\\b[^}]*\\}\\s+from\\s+['"][^'"]+['"];?\\n`, 'g');
