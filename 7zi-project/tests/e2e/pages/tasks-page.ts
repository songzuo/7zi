...
export class TasksPage {
  ...
  constructor(page: Page) {
    ...
    this.taskTitleInput = page.locator('input[name*="title"], input[placeholder*="标题"], input[placeholder*="Title"]');
    this.taskDescriptionInput = page.locator('textarea[name*="description"], textarea[placeholder*="描述"]');
    this.prioritySelect = page.locator('select[name*="priority"], [role="combobox"][aria-label*="priority"]');
