...
import { waitForPageLoad, clearLocalStorage, generateRandomEmail, generateRandomTitle } from '../helpers/test-helpers';

test.describe('Complete User Workflow', () => {
  test('should complete full user journey: register -> login -> dashboard -> create task', async ({ page }) => {
 ...
 */
async function waitForPageState(page: Page, state: 'load' | 'domcontentloaded' | 'networkidle', timeout: number = 30000): Promise<void> {
