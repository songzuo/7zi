...
export class TaskCreationPage {
  ...
  constructor(page: Page) {
    ...
    // Form fields
    this.titleInput = page.locator('input[name="title"], input[placeholder*="标题"], input[placeholder*="Title"]');
    this.descriptionTextarea = page.locator('textarea[name="description"], textarea[placeholder*="描述"], textarea[placeholder*="Description"]');
    ...
    this.dueDateInput = page.locator('input[type="date"], input[name="dueDate"], input[name="deadline"]');
    this.tagsInput = page.locator('input[name="tags"], input[placeholder*="标签"], input[placeholder*="Tags"]');

    // Buttons
    this.submitButton = page.locator('button[type="submit"]');
    this.cancelButton = page.locator('button:has-text("取消"), button:has-text("Cancel"), button[aria-label*="close"]');
  }
