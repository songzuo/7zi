...
export class NavigationPage {
  ...
  constructor(page: Page) {
    ...
    this.logoutButton = page.locator('button:has-text("退出"), button:has-text("Logout"), button:has-text("Sign Out")');

    // Theme and language
    this.themeToggle = page.locator('button[aria-label*="theme"], button[aria-label*="mode"], .theme-toggle');
