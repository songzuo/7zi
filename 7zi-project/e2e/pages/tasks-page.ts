...
export class TasksPage {
  ...
  constructor(page: Page) {
    ...
    this.createTaskButton = page.locator('button:has-text("新建任务"), button:has-text("Create Task"), button:has-text("Add Task")');
  ...
  async deleteTask(index: number): Promise<void> {
    const task = this.taskCards.nth(index);
    const deleteButton = task.locator('.delete-button, button:has-text("删除"), button:has-text("Delete")');
  ...
  async editTask(index: number): Promise<void> {
    const task = this.taskCards.nth(index);
    const editButton = task.locator('.edit-button, button:has-text("编辑"), button:has-text("Edit")');
