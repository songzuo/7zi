...
test.describe('Dashboard Analytics', () => {
  ...
  test('should filter dashboard by date range', async ({ page }) => {
    ...
    const dateRangePicker = page.locator('.date-range-picker, [role="combobox"], input[type="date"]');
  ...
  test('should export dashboard report', async ({ page }) => {
    ...
    // Find export button
    const exportButton = page.locator('button:has-text("导出"), button:has-text("Export"), button:has-text("下载报告")');
...
test.describe('Analytics Page', () => {
  ...
  test('should show time-based analytics', async ({ page }) => {
    ...
    const timeFilters = page.locator('button:has-text("今天"), button:has-text("本周"), button:has-text("本月")');
...
test.describe('Report Generation', () => {
  ...
  test('should schedule automated reports', async ({ page }) => {
    ...
    const scheduleButton = page.locator('button:has-text("定时报告"), button:has-text("Schedule Report")');
