  ...
  static async webSearch(
    ...
    return {
      content: [
        {
          type: "text",
          text: `[Integration Required] Web search for: ${query}\n\n` +
  ...
  static async webFetch(
    ...
    return {
      content: [
        {
          type: "text",
          text: `[Integration Required] Fetching: ${url}\n\n` +
...
export class ToolExecutor {
  ...
  static async execute(name: string, args: Record<string, unknown>): Promise<ToolExecutionResult> {
    switch (name) {
      ...
      // Command tools
      case "exec_command":
        return CommandTools.executeCommand(
      ...
      case "web_fetch":
        return WebTools.webFetch(args.url as string, { extractMode: args.extractMode as "markdown" | "text" | undefined });
      ...
      case "browser_control":
        return {
          content: [
            {
              type: "text",
              text: `[Integration Required] Browser action: ${args.action}\n\n` +
