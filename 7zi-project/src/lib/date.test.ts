...
describe('date.ts', () => {
  ...
  describe('isToday', () => {
    ...
    it('should return true for different times today', () => {
      ...
      const evening = new Date(fixedNow.getFullYear(), fixedNow.getMonth(), fixedNow.getDate(), 23, 59, 59);
  ...
  describe('isYesterday', () => {
    ...
    it('should return true for different times yesterday', () => {
      ...
      const yesterdayEvening = new Date(yesterdayDate.getTime() + 23 * 60 * 60 * 1000 + 59 * 60 * 1000 + 59 * 1000);
