...
describe('NotificationService', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should not initialize twice', () => {
      ...
      expect(mockLogger.warn).toHaveBeenCalledWith('[NotificationService] Already initialized');
    });
  });
  ...
  describe('Notification Filtering', () => {
    ...
    it('should filter by read status', () => {
      ...
      const allNotifications = service.getNotifications();
      service.markAsRead(allNotifications[1].id);
    ...
    it('should apply multiple filters', () => {
      // Mark user-1's first notification as read
      const user1Notifications = service.getNotifications({ userId: 'user-1' });
      service.markAsRead(user1Notifications[0].id);
