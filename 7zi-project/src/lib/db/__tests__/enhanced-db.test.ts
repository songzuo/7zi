...
describe('Enhanced Database', () => {
  ...
  describe('database operations', () => {
    ...
    it('should execute batch operations', async () => {
      ...
      const statements = [
        { sql: 'INSERT INTO users (name, email) VALUES (?, ?)', params: ['User 1', 'user1@test.com'] },
        { sql: 'INSERT INTO users (name, email) VALUES (?, ?)', params: ['User 2', 'user2@test.com'] },
        { sql: 'INSERT INTO users (name, email) VALUES (?, ?)', params: ['User 3', 'user3@test.com'] },
      ];
