...
describe('MultiAgentOrchestrator', () => {
  ...
  const mockAgents: Agent[] = [
    { id: 'agent-1', name: 'Researcher', capabilities: ['research', 'analysis'], status: 'online', currentLoad: 0.2 },
    { id: 'agent-2', name: 'Coder', capabilities: ['coding', 'debugging'], status: 'online', currentLoad: 0.3 },
    { id: 'agent-3', name: 'Writer', capabilities: ['writing', 'translation'], status: 'online', currentLoad: 0.1 },
    { id: 'agent-4', name: 'Analyst', capabilities: ['analysis', 'visualization'], status: 'busy', currentLoad: 0.8 },
    { id: 'agent-5', name: 'MultiSkill', capabilities: ['research', 'coding', 'analysis'], status: 'online', currentLoad: 0.5 },
  ];
  ...
  describe('executeParallel', () => {
    test('should execute task in parallel with multiple agents', async () => {
      ...
      const researchAgents = mockAgents.filter(a =>
        a.capabilities.includes('research') && a.status === 'online'
      );
    ...
    test('should aggregate results using "first" strategy', async () => {
      ...
      const agents = mockAgents.filter(a =>
        a.capabilities.includes('analysis') && a.status === 'online'
      );
    ...
    test('should aggregate results using "all" strategy', async () => {
      ...
      const agents = mockAgents.filter(a =>
        a.capabilities.includes('coding') && a.status === 'online'
      );
