...
describe('OptimizedImage', () => {
  ...
  describe('加载状态回调', () => {
    it('应该调用 onLoad 回调', async () => {
      ...
      render(
        <OptimizedImage src="/test.jpg" alt="Test image" priority onLoad={onLoad} />
      );
    ...
    it('应该调用 onError 回调', async () => {
      ...
      render(
        <OptimizedImage src="/invalid.jpg" alt="Test image" priority onError={onError} />
      );
    ...
    it('错误后应该显示错误图标', async () => {
      const { container } = render(
        <OptimizedImage src="/invalid.jpg" alt="Test image" priority />
      );
  ...
  describe('响应式属性', () => {
    it('应该支持 sizes 属性', async () => {
      render(<OptimizedImage src="/test.jpg" alt="Test image" sizes="(max-width: 768px) 100vw, 50vw" priority />);
...
describe('ResponsiveImage', () => {
  ...
  describe('基本渲染', () => {
    ...
    it('默认应该使用 16:9 宽高比', async () => {
      const { container } = render(
        <ResponsiveImage src="/test.jpg" alt="Test image" priority />
      );
