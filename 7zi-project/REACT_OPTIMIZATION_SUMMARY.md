...
// MemberStatus.tsx
const workingMembers = React.useMemo(() =>
...
- ✅ 只渲染可视区域内的项目
- ✅ 预渲染 5 个项目提升滚动流畅度
- ✅ 自动判断数据量：>50 条使用虚拟化，≤50 条使用静态版本
- ✅ 保持原有 UI 样式和交互不变

**已更新的组件**:
- `ActivityLog.tsx` - 活动日志列表虚拟化
- `MemberCard.tsx` - 成员卡片列表虚拟化
