...
describe('/api/search - Integration Tests', () => {
  ...
  describe('GET /api/search - Query Parameters', () => {
    ...
    it('should handle long query strings', async () => {
      ...
      const response = await fetch(
        `http://localhost:3000/api/search?q=${encodeURIComponent(longQuery)}`
      )
      const data = await response.json()
  ...
  describe('GET /api/search - Advanced Filters', () => {
    ...
    it('should filter by multiple statuses', async () => {
      const response = await fetch(
        'http://localhost:3000/api/search?q=test&status=pending,in_progress'
      )
      const data = await response.json()
    ...
    it('should filter by date range (createdAfter)', async () => {
      ...
      const response = await fetch(
        `http://localhost:3000/api/search?q=test&createdAfter=${encodeURIComponent(date)}`
      )
      const data = await response.json()
    ...
    it('should filter by date range (createdBefore)', async () => {
      ...
      const response = await fetch(
        `http://localhost:3000/api/search?q=test&createdBefore=${encodeURIComponent(date)}`
      )
      const data = await response.json()
  ...
  describe('GET /api/search - Error Handling', () => {
    it('should handle invalid date format gracefully', async () => {
      const response = await fetch(
        'http://localhost:3000/api/search?q=test&createdAfter=invalid-date'
      )
      const data = await response.json()
  ...
  describe('Pagination Tests', () => {
    it('should return empty results on first page when no data', async () => {
      const response = await fetch(
        'http://localhost:3000/api/search?q=nonexistent&limit=10&offset=0'
      )
      const data = await response.json()
  ...
  describe('Empty Results Tests', () => {
    ...
    it('should return empty results with pagination metadata', async () => {
      const response = await fetch(
        'http://localhost:3000/api/search?q=nonexistentxyz&limit=10&offset=0'
      )
      const data = await response.json()
  ...
  describe('Advanced Search Configuration Tests', () => {
    it('should handle case-sensitive search', async () => {
      ...
      const response = await fetch(
        'http://localhost:3000/api/search?q=CaseSensitive&caseSensitive=true'
      )
      const data = await response.json()
    ...
    it('should handle fuzzy search with threshold', async () => {
      ...
      const response = await fetch(
        'http://localhost:3000/api/search?q=FuzzyMatc&fuzzy=true&fuzzyThreshold=0.3'
      )
      const data = await response.json()
    ...
    it('should handle combination of filters and config', async () => {
      ...
      const response = await fetch(
        'http://localhost:3000/api/search?q=Combined&status=pending&priority=high&caseSensitive=false&fuzzy=true'
      )
      const data = await response.json()
