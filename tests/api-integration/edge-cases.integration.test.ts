  ...
  describe('/api/search - Edge Cases', () => {
    ...
    describe('Special Characters Injection', () => {
      it('should handle SQL injection in query', async () => {
        ...
        const response = await fetch(
          `http://localhost:3000/api/search?q=${encodeURIComponent(sqlInjection)}`
        )
        const data = await response.json()
      ...
      it('should handle XSS in query', async () => {
        ...
        const response = await fetch(
          `http://localhost:3000/api/search?q=${encodeURIComponent(xss)}`
        )
        const data = await response.json()
      ...
      it('should handle special regex characters', async () => {
        const regexChars = '.*+?^${}()|[]\\'
        const response = await fetch(
          `http://localhost:3000/api/search?q=${encodeURIComponent(regexChars)}`
        )
        const data = await response.json()
      ...
      it('should handle unicode and emoji in query', async () => {
        ...
        const response = await fetch(
          `http://localhost:3000/api/search?q=${encodeURIComponent(unicodeQuery)}`
        )
        const data = await response.json()
      ...
      it('should handle null byte injection', async () => {
        ...
        const response = await fetch(
          `http://localhost:3000/api/search?q=${encodeURIComponent(nullByte)}`
        )
        const data = await response.json()
