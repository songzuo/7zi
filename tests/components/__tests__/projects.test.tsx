...
describe('Project Components', () => {
  ...
  describe('ProjectForm', () => {
      ...
      render(
        <form data-testid="project-form">
          <div>
            ...
            <input id="project-name" name="name" type="text" data-testid="name-input" />
          </div>
          <div>
            <label htmlFor="project-description">Description</label>
            <textarea id="project-description" name="description" data-testid="description-input" />
          </div>
    ...
    it('should validate required fields', async () => {
      ...
      render(
        <form data-testid="project-form" onSubmit={onSubmit}>
          <input name="name" type="text" data-testid="name-input" required />
          <button type="submit" data-testid="submit-btn">
            Submit
          </button>
        </form>
    ...
    it('should handle form submission with correct data', async () => {
      ...
      render(
        <form data-testid="project-form" onSubmit={onSubmit}>
          <input name="name" type="text" defaultValue="Test Project" data-testid="name-input" />
          <textarea
            name="description"
