...
vi.mock("@xyflow/react", () => {
  ...
  return {
    ReactFlow: ({ children, nodes, edges, onNodesChange, onEdgesChange, onConnect, onEdgeClick, nodeTypes, fitView }: any) => (
    ...
    MiniMap: ({ nodeColor, className }: any) => (
  ...
  describe("边界情况", () => {
    ...
    it("应该处理没有 label 的连接", () => {
      ...
      render(
        <CollaborationGraph
          agentNodes={mockAgentNodes}
          connections={[connectionWithoutLabel]}
        />
      );
