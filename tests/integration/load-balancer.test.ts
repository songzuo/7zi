...
describe('Load Balancer Integration Tests', () => {
  ...
  describe('Overload Protection', () => {
    it('should prevent overloading agents', () => {
      const agentArray = Array.from(agents.values())
      const implAgents = agentArray.filter(a => a.capabilities.taskTypes.includes('implementation'))
  ...
  describe('Load Balancing Algorithm', () => {
    ...
    it('should redistribute tasks from overloaded agents', () => {
      ...
      const alternatives = loadBalancer.redistributeTasks(overloadedAgent.agentId, agents, task)
  ...
  describe('Agent Availability Sorting', () => {
    ...
    it('should sort available agents by load', () => {
      const agentArray = Array.from(agents.values())
      const implAgents = agentArray.filter(
        a => a.capabilities.taskTypes.includes('implementation') && a.availability
      )
