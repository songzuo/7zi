...
import { TaskPriority, TaskStatus, TaskType } from '@/lib/agent-scheduler/models/task-model'
...
describe('Scheduler Integration Tests', () => {
  ...
  describe('Load Balancing', () => {
    it('should distribute tasks across multiple agents', async () => {
      ...
      const uniqueAgents = new Set(result.scheduled.map(d => d.assignedAgent))
  ...
  describe('Manual Assignment', () => {
    it('should allow manual task assignment', () => {
      ...
      const decision = scheduler.manualAssign(task.id, targetAgent, 'test-user')
