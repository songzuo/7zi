...
export class DashboardPage {
  ...
  constructor(page: Page) {
    ...
    this.homeLink = page
      .locator('a[href*="/"], a[href*="dashboard"]')
      .filter({ hasText: /首页|仪表盘|Dashboard|Home/i })
    ...
    this.welcomeMessage = page
      .locator('[class*="welcome"], h1, h2')
      .filter({ hasText: /欢迎|Welcome/i })
    this.noDataMessage = page
      .locator('[class*="no-data"], [class*="empty"]')
      .filter({ hasText: /暂无|No data|Empty/i })
  }
