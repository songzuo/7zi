...
import { waitForToast, clearLocalStorage, waitForPageLoad, generateRandomEmail } from '../helpers/test-helpers';
...
test.describe('Authentication Flow', () => {
  ...
  test.describe('Login', () => {
    ...
    test('should login with remember me checked', async ({ page }) => {
      ...
      const rememberCookie = cookies.find(c => c.name.includes('remember') || c.name.includes('token'));
  ...
  test.describe('Navigation between Auth Pages', () => {
    ...
    test('should navigate to forgot password page', async ({ page }) => {
      ...
      expect(page.url()).toContain('/forgot-password') || expect(page.url()).toContain('/reset-password');
    });
  });
