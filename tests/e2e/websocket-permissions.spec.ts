...
test.describe('Role Permissions', () => {
  ...
  test('should have correct admin permissions', async ({ page, context }) => {
    ...
    const expectedPermissions = [
      ...
      ...messagePermissions,
      ...adminPermissions.filter(p => 
        p !== 'admin:manage_permissions' // Admin cannot manage permissions
      ),
    ];
  ...
  test('should have correct member permissions', async ({ page, context }) => {
    ...
    const deniedPermissions = [
      'room:manage', 'room:kick', 'room:ban',
  ...
  test('should have correct guest permissions', async ({ page, context }) => {
    ...
    const deniedPermissions = [
      'room:manage', 'room:invite', 'room:kick', 'room:ban',
      'message:edit', 'message:delete', 'message:pin', 'message:view_history',
      ...adminPermissions,
    ];
