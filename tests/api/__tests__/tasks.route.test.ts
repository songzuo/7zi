  ...
  describe('GET /api/tasks - List tasks', () => {
    ...
    it('should handle sort by createdAt', async () => {
      ...
      const request = new NextRequest(
        'http://localhost/api/tasks?sortBy=createdAt&sortOrder=desc'
      );
    ...
    it('should handle sort by priority', async () => {
      const { GET } = await import('@/app/api/tasks/route');
      const request = new NextRequest(
        'http://localhost/api/tasks?sortBy=priority&sortOrder=asc'
      );
    ...
    it('should handle createdBy filter', async () => {
      const { GET } = await import('@/app/api/tasks/route');
      const request = new NextRequest(
        'http://localhost/api/tasks?createdBy=user-123'
      );
    ...
    it('should handle assignedTo filter', async () => {
      const { GET } = await import('@/app/api/tasks/route');
      const request = new NextRequest(
        'http://localhost/api/tasks?assignedTo=user-456'
      );
