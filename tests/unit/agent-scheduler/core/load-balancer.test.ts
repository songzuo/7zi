...
import { AgentCapability, createAgentCapability, TaskType } from '@/lib/agent-scheduler/models/agent-capability';
...
describe('LoadBalancer', () => {
  ...
  beforeEach(() => {
    ...
    testAgents.set('agent1', createAgentCapability({
      agentId: 'agent1',
      name: 'Agent 1',
      provider: 'minimax',
      role: 'architect',
    ...
    testAgents.set('agent2', createAgentCapability({
      agentId: 'agent2',
      name: 'Agent 2',
    ...
    testAgents.set('agent3', createAgentCapability({
      agentId: 'agent3',
      name: 'Agent 3',
      provider: 'volcengine',
      role: 'executor',
  ...
  describe('redistributeTasks', () => {
    ...
    it('should return empty for non-existent agent', () => {
      ...
      const candidates = balancer.redistributeTasks('nonexistent', testAgents, task);
  ...
  describe('suggestScaling', () => {
    ...
    it('should not scale below minimum agents', () => {
      ...
      singleAgent.set('agent1', createAgentCapability({
        agentId: 'agent1',
        name: 'Agent 1',
        provider: 'minimax',
        role: 'test',
