...
describe('TaskRanker', () => {
  ...
  describe('rankTasks', () => {
    ...
    it('should prioritize overdue tasks', () => {
      ...
      const overdueTask = ranked.find(r => r.task.deadline && r.task.deadline < Date.now())
  ...
  describe('calculateDependencyScore', () => {
    ...
    it('should scale score based on dependency count', () => {
      ...
      expect(ranked[0].dependencyScore).toBeGreaterThan(ranked[1].dependencyScore)
    })
  })
  ...
  describe('getTasksByPriority', () => {
    ...
    it('should return empty array for non-existent priority', () => {
      const tasks = ranker.getTasksByPriority(testTasks, 'urgent' as TaskPriority)
  ...
  describe('getOverdueTasks', () => {
    it('should identify overdue tasks', () => {
      ...
      expect(overdue.every(t => t.deadline && t.deadline < Date.now())).toBe(true)
    })
