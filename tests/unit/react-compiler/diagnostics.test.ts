...
import { ComponentScanner, CompilerIssue, IncompatibilityReport } from '../../../src/lib/react-compiler/diagnostics/scanner';
...
import { generateCompatibilityReport, generateMarkdownReport } from '../../../src/lib/react-compiler/diagnostics/reporter';
      ...
      reports: [
        {
          ...
          componentName: 'Test',
          issues: [
            { type: 'unsupported-pattern', message: 'Test issue', severity: 'high' }
          ],
          canCompile: false,
          estimatedEffort: 'high',
        }
    ...
    const scanResult = {
      ...
      reports: [
        ...
        },
        {
          ...
          componentName: 'Easy',
          issues: [
            { type: 'performance-warning', message: 'Test', severity: 'low' }
          ],
          canCompile: false,
