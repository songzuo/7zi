...
import { generateCompatibilityReport, generateMarkdownReport, generateHTMLReport, reportToString } from '../../../src/lib/react-compiler/diagnostics/reporter';
...
describe('Reporter', () => {
        ...
        reports: [
          {
            ...
            componentName: 'Test',
            issues: [
              { type: 'unsupported-pattern' as const, message: 'Test issue', severity: 'high' as const }
            ],
            canCompile: false,
        ...
        reports: [
          {
            ...
            componentName: 'High',
            issues: [
              { type: 'unsupported-pattern' as const, message: 'High issue', severity: 'high' as const }
            ],
            canCompile: false,
            estimatedEffort: 'high' as const,
          },
          {
            ...
            issues: [
              { type: 'side-effect' as const, message: 'Medium issue', severity: 'medium' as const }
            ],
            canCompile: true,
          ...
          },
          {
            ...
            componentName: 'Low',
            issues: [
              { type: 'performance-warning' as const, message: 'Low issue', severity: 'low' as const }
            ],
            canCompile: true,
  ...
  describe('generateMarkdownReport', () => {
    it('应该生成 Markdown 格式报告', () => {
        ...
        reports: [
          {
            ...
            componentName: 'Test',
            issues: [
              { type: 'unsupported-pattern' as const, message: 'Test issue', severity: 'high' as const, line: 10, suggestion: 'Fix it' }
            ],
            canCompile: false,
            estimatedEffort: 'high' as const,
          }
      ...
      const report = generateCompatibilityReport(scanResult, { format: 'markdown', includeDetails: true });
