...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // 追踪响应时间
    const anomaly = enhancedAnomalyDetector.trackResponseTime('api.getUser', duration)
    ...
    // 追踪错误率
    enhancedAnomalyDetector.trackErrorRate(calculateErrorRate(), totalRequests, errorCount)
