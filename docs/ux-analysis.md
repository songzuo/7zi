...
<div className="flex justify-between mt-2">
  <span className="text-sm text-zinc-500">
    {formData.message.length} 字符 (最少 10)
  </span>
</div>
```
...
```css
/* 问题示例 */
.text-zinc-400 { color: #a1a1aa; } /* 在白色背景上对比度约 3.4:1，低于 WCAG AA 标准 4.5:1 */

/* 建议修改 */
.text-zinc-400 { color: #71717a; } /* zinc-500，对比度约 4.6:1 */
```
